...
--            luakit.spawn(string.format("tixati %q", uri))
--            return false
--        end 
--    end)
--end
...
follow.label_maker = s.sort(s.reverse(s.charset("arstdhneioqwfpgjluykmzxcvb")))
-- =================================================================================
...
-- =================================================================================
-- adblock interferes with "comments" sections for some websites
--require "adblock"
