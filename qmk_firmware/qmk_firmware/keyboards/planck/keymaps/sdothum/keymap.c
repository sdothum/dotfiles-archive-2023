...
// http://www.keyboard-layout-editor.com/#/gists/5e11e5e90ee2b40cb5caf0f9231f23f7
  ...
  [_NUMHEX] = {
    {_______, _______, _______, ___x___, _______, _______, _______, KC_RCBR, TD_LCBR, S(KC_D), S(KC_E), S(KC_F)},
    {___x___, ___x___, ___x___, ___x___, _______, _______, _______, KC_RPRN, TD_LPRN, S(KC_A), S(KC_B), S(KC_C)},
    {_______, _______, _______, ___x___, _______, _______, _______, KC_RBRC, TD_LBRC, KC_LT,   KC_GT,   S(KC_G)},
...
// http://www.keyboard-layout-editor.com/#/gists/475b46cf0546fd102b5d7cb729c490a6
  ...
  [_SYMREG] = {
    {___x___, KC_COLN, KC_PLUS, KC_TILD, ___x___, _______, _______, _______, ___x___, ___x___, ___x___, ___x___},
    {___x___, KC_3,    KC_2,    KC_1,    ___x___, _______, _______, _______, ___x___, ___x___, ___x___, ___x___},
    {___x___, KC_QUES, KC_SLSH, KC_EQL,  ___x___, _______, _______, _______, _______, ___x___, ___x___, _______},
...
// http://www.keyboard-layout-editor.com/#/gists/863abbf3ae716a267b60337a953588d5
  ...
  [_MOUSE] = {
    {_______, _______, KC_BTN4, _______, _______, _______, _______, _______, KC_WH_L, KC_MS_U, KC_WH_R, KC_WH_U},
    {_______, KC_BTN3, KC_BTN2, KC_BTN1, _______, _______, _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D},
    {_______, _______, _______, KC_BTN5, _______, _______, _______, _______, _______, _______, _______, _______},
...
// http://www.keyboard-layout-editor.com/#/gists/aeb9c497167a17c3bc8efb2f1d88be48
  ...
  [_EDIT] = {
    {_______, _______, TMCOPY,  _______, _______, _______, _______, _______, _______, _______, _______, _______},
    {UNDO,    CUT,     COPY,    PASTE,   _______, _______, _______, _______, TD_PRIV, TD_SEND, _______, _______},
    {_______, _______, _______, TMPASTE, _______, _______, _______, _______, _______, _______, _______, _______},
...
// http://www.keyboard-layout-editor.com/#/gists/08f08c811c7dc502617f0758bce59bf6
  ...
  [_ADJUST] = {
    {QWERTY,  _______, COLEMAK, _______, _______, _______, _______, _______, _______, _______, _______, _______},
    {AU_ON,   RESET,   _______, _______, PLOVER,  _______, _______, _______, _______, _______, _______, _______},
