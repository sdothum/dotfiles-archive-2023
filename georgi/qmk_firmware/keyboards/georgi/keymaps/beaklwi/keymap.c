...
const struct Chord chord_43 PROGMEM = {H_THU1, BEAKL, &state_43, &counter_43, KC_ESC, FNC, key_layer_dance};
uint8_t state_44 = IDLE;
uint8_t counter_44 = 0;
const struct Chord chord_44 PROGMEM = {H_THU2, BEAKL, &state_44, &counter_44, KC_I, REGEX, key_layer_dance};
uint8_t state_45 = IDLE;
uint8_t counter_45 = 0;
const struct Chord chord_45 PROGMEM = {H_THU3, BEAKL, &state_45, &counter_45, KC_TAB, NUM, key_layer_dance};
uint8_t state_46 = IDLE;
uint8_t counter_46 = 0;
const struct Chord chord_46 PROGMEM = {H_THU4, BEAKL, &state_46, &counter_46, KC_ENTER, NAV, key_layer_dance};
uint8_t state_47 = IDLE;
uint8_t counter_47 = 0;
const struct Chord chord_47 PROGMEM = {H_THU5, BEAKL, &state_47, &counter_47, KC_SPC, SYM, key_layer_dance};
uint8_t state_48 = IDLE;
uint8_t counter_48 = 0;
const struct Chord chord_48 PROGMEM = {H_THU6, BEAKL, &state_48, &counter_48, KC_BSPC, MOUSE, key_layer_dance};
uint8_t state_49 = IDLE;
const struct Chord chord_49 PROGMEM = {H_TOP1, CAPS, &state_49, NULL, FNC, 0, perm_pseudolayer};
uint8_t state_50 = IDLE;
const struct Chord chord_50 PROGMEM = {H_TOP2, CAPS, &state_50, NULL, KC_COLON, 0, single_dance};
...
const struct Chord chord_51 PROGMEM = {H_TOP3, CAPS, &state_51, &counter_51, 0, 0, function_51};
...
const struct Chord chord_52 PROGMEM = {H_TOP4, CAPS, &state_52, &counter_52, 0, 0, function_52};
...
const struct Chord chord_53 PROGMEM = {H_TOP5, CAPS, &state_53, &counter_53, 0, 0, function_53};
uint8_t state_54 = IDLE;
const struct Chord chord_54 PROGMEM = {H_TOP6, CAPS, &state_54, NULL, KC_MINUS, 0, single_dance};
...
const struct Chord chord_55 PROGMEM = {H_TOP7, CAPS, &state_55, &counter_55, 0, 0, function_55};
...
const struct Chord chord_56 PROGMEM = {H_TOP8, CAPS, &state_56, &counter_56, 0, 0, function_56};
...
const struct Chord chord_57 PROGMEM = {H_TOP9, CAPS, &state_57, &counter_57, 0, 0, function_57};
...
const struct Chord chord_58 PROGMEM = {H_TOP10, CAPS, &state_58, &counter_58, 0, 0, function_58};
...
const struct Chord chord_59 PROGMEM = {H_TOP11, CAPS, &state_59, &counter_59, 0, 0, function_59};
uint8_t state_60 = IDLE;
const struct Chord chord_60 PROGMEM = {H_TOP12, CAPS, &state_60, NULL, SYMBOL, 0, perm_pseudolayer};
uint8_t state_61 = IDLE;
const struct Chord chord_61 PROGMEM = {H_TOP1 + H_BOT1, CAPS, &state_61, NULL, MOUSE, 0, perm_pseudolayer};
...
const struct Chord chord_72 PROGMEM = {H_TOP12 + H_BOT12, CAPS, &state_72, NULL, NAV, 0, perm_pseudolayer};
uint8_t state_73 = IDLE;
const struct Chord chord_73 PROGMEM = {H_BOT1, CAPS, &state_73, NULL, BEAKL, 0, perm_pseudolayer};
...
const struct Chord chord_74 PROGMEM = {H_BOT2, CAPS, &state_74, &counter_74, 0, 0, function_74};
uint8_t state_75 = IDLE;
const struct Chord chord_75 PROGMEM = {H_BOT3, CAPS, &state_75, NULL, KC_COMMA, 0, single_dance};
uint8_t state_76 = IDLE;
const struct Chord chord_76 PROGMEM = {H_BOT4, CAPS, &state_76, NULL, KC_DOT, 0, single_dance};
...
const struct Chord chord_77 PROGMEM = {H_BOT5, CAPS, &state_77, &counter_77, 0, 0, function_77};
uint8_t state_78 = IDLE;
const struct Chord chord_78 PROGMEM = {H_BOT6, CAPS, &state_78, NULL, KC_QUOTE, 0, single_dance};
...
const struct Chord chord_79 PROGMEM = {H_BOT7, CAPS, &state_79, &counter_79, 0, 0, function_79};
...
const struct Chord chord_80 PROGMEM = {H_BOT8, CAPS, &state_80, &counter_80, 0, 0, function_80};
...
const struct Chord chord_81 PROGMEM = {H_BOT9, CAPS, &state_81, &counter_81, 0, 0, function_81};
...
const struct Chord chord_82 PROGMEM = {H_BOT10, CAPS, &state_82, &counter_82, 0, 0, function_82};
...
const struct Chord chord_83 PROGMEM = {H_BOT11, CAPS, &state_83, &counter_83, 0, 0, function_83};
uint8_t state_84 = IDLE;
const struct Chord chord_84 PROGMEM = {H_BOT12, CAPS, &state_84, NULL, NUM, 0, perm_pseudolayer};
uint8_t state_85 = IDLE;
const struct Chord chord_85 PROGMEM = {H_TOP2 + H_TOP8 + H_BOT8, CAPS, &state_85, NULL, KC_SCOLON, 0, single_dance};
uint8_t state_86 = IDLE;
const struct Chord chord_86 PROGMEM = {H_BOT3 + H_TOP8 + H_BOT8, CAPS, &state_86, NULL, KC_GRAVE, 0, single_dance};
uint8_t state_87 = IDLE;
const struct Chord chord_87 PROGMEM = {H_BOT4 + H_TOP8 + H_BOT8, CAPS, &state_87, NULL, KC_TILDE, 0, single_dance};
uint8_t state_88 = IDLE;
const struct Chord chord_88 PROGMEM = {H_TOP6 + H_TOP8 + H_BOT8, CAPS, &state_88, NULL, KC_UNDERSCORE, 0, single_dance};
uint8_t state_89 = IDLE;
const struct Chord chord_89 PROGMEM = {H_BOT6 + H_TOP8 + H_BOT8, CAPS, &state_89, NULL, KC_DOUBLE_QUOTE, 0, single_dance};
uint8_t state_90 = IDLE;
uint8_t counter_90 = 0;
const struct Chord chord_90 PROGMEM = {H_THU1, CAPS, &state_90, &counter_90, KC_ESC, FNC, key_layer_dance};
uint8_t state_91 = IDLE;
uint8_t counter_91 = 0;
const struct Chord chord_91 PROGMEM = {H_THU2, CAPS, &state_91, &counter_91, KC_I, REGEX, key_layer_dance};
uint8_t state_92 = IDLE;
uint8_t counter_92 = 0;
const struct Chord chord_92 PROGMEM = {H_THU3, CAPS, &state_92, &counter_92, KC_TAB, NUM, key_layer_dance};
uint8_t state_93 = IDLE;
uint8_t counter_93 = 0;
const struct Chord chord_93 PROGMEM = {H_THU4, CAPS, &state_93, &counter_93, KC_ENTER, NAV, key_layer_dance};
uint8_t state_94 = IDLE;
uint8_t counter_94 = 0;
const struct Chord chord_94 PROGMEM = {H_THU5, CAPS, &state_94, &counter_94, KC_SPC, SYM, key_layer_dance};
uint8_t state_95 = IDLE;
uint8_t counter_95 = 0;
const struct Chord chord_95 PROGMEM = {H_THU6, CAPS, &state_95, &counter_95, KC_BSPC, MOUSE, key_layer_dance};
uint8_t state_96 = IDLE;
const struct Chord chord_96 PROGMEM = {H_TOP7, REGEX, &state_96, NULL, KC_ASTERISK, 0, single_dance};
uint8_t state_97 = IDLE;
const struct Chord chord_97 PROGMEM = {H_TOP8, REGEX, &state_97, NULL, KC_LBRACKET, 0, single_dance};
uint8_t state_98 = IDLE;
const struct Chord chord_98 PROGMEM = {H_TOP9, REGEX, &state_98, NULL, KC_CIRCUMFLEX, 0, single_dance};
uint8_t state_99 = IDLE;
const struct Chord chord_99 PROGMEM = {H_TOP10, REGEX, &state_99, NULL, KC_RBRACKET, 0, single_dance};
uint8_t state_100 = IDLE;
const struct Chord chord_100 PROGMEM = {H_TOP7 + H_BOT7, REGEX, &state_100, NULL, KC_QUESTION, 0, single_dance};
uint8_t state_101 = IDLE;
const struct Chord chord_101 PROGMEM = {H_TOP8 + H_BOT8, REGEX, &state_101, NULL, KC_LPRN, 0, single_dance};
uint8_t state_102 = IDLE;
const struct Chord chord_102 PROGMEM = {H_TOP9 + H_BOT9, REGEX, &state_102, NULL, KC_DOLLAR, 0, single_dance};
uint8_t state_103 = IDLE;
const struct Chord chord_103 PROGMEM = {H_TOP10 + H_BOT10, REGEX, &state_103, NULL, KC_RPRN, 0, single_dance};
uint8_t state_104 = IDLE;
const struct Chord chord_104 PROGMEM = {H_BOT7, REGEX, &state_104, NULL, KC_PIPE, 0, single_dance};
uint8_t state_105 = IDLE;
const struct Chord chord_105 PROGMEM = {H_BOT8, REGEX, &state_105, NULL, KC_LEFT_CURLY_BRACE, 0, single_dance};
uint8_t state_106 = IDLE;
const struct Chord chord_106 PROGMEM = {H_BOT9, REGEX, &state_106, NULL, KC_HASH, 0, single_dance};
uint8_t state_107 = IDLE;
const struct Chord chord_107 PROGMEM = {H_BOT10, REGEX, &state_107, NULL, KC_RIGHT_CURLY_BRACE, 0, single_dance};
uint8_t state_108 = IDLE;
const struct Chord chord_108 PROGMEM = {H_THU5, REGEX, &state_108, NULL, KC_BSLASH, 0, single_dance};
uint8_t state_109 = IDLE;
const struct Chord chord_109 PROGMEM = {H_THU6, REGEX, &state_109, NULL, KC_DEL, 0, single_dance};
uint8_t state_110 = IDLE;
const struct Chord chord_110 PROGMEM = {H_TOP3, SYM, &state_110, NULL, KC_DOT, 0, single_dance};
uint8_t state_111 = IDLE;
const struct Chord chord_111 PROGMEM = {H_TOP4, SYM, &state_111, NULL, KC_ASTERISK, 0, single_dance};
uint8_t state_112 = IDLE;
const struct Chord chord_112 PROGMEM = {H_TOP5, SYM, &state_112, NULL, KC_AMPERSAND, 0, single_dance};
uint8_t state_113 = IDLE;
const struct Chord chord_113 PROGMEM = {H_TOP6, SYM, &state_113, NULL, KC_PLUS, 0, single_dance};
uint8_t state_114 = IDLE;
const struct Chord chord_114 PROGMEM = {H_TOP3 + H_BOT3, SYM, &state_114, NULL, KC_QUESTION, 0, single_dance};
uint8_t state_115 = IDLE;
const struct Chord chord_115 PROGMEM = {H_TOP4 + H_BOT4, SYM, &state_115, NULL, KC_EXCLAIM, 0, single_dance};
uint8_t state_116 = IDLE;
const struct Chord chord_116 PROGMEM = {H_TOP5 + H_BOT5, SYM, &state_116, NULL, KC_SLASH, 0, single_dance};
uint8_t state_117 = IDLE;
const struct Chord chord_117 PROGMEM = {H_TOP6 + H_BOT6, SYM, &state_117, NULL, KC_PIPE, 0, single_dance};
uint8_t state_118 = IDLE;
const struct Chord chord_118 PROGMEM = {H_BOT3, SYM, &state_118, NULL, KC_LEFT_ANGLE_BRACKET, 0, single_dance};
uint8_t state_119 = IDLE;
const struct Chord chord_119 PROGMEM = {H_BOT4, SYM, &state_119, NULL, KC_RIGHT_ANGLE_BRACKET, 0, single_dance};
uint8_t state_120 = IDLE;
const struct Chord chord_120 PROGMEM = {H_BOT5, SYM, &state_120, NULL, KC_PERCENT, 0, single_dance};
uint8_t state_121 = IDLE;
const struct Chord chord_121 PROGMEM = {H_BOT6, SYM, &state_121, NULL, KC_AT, 0, single_dance};
uint8_t state_122 = IDLE;
const struct Chord chord_122 PROGMEM = {H_THU2, SYM, &state_122, NULL, KC_EQUAL, 0, single_dance};
uint8_t state_123 = IDLE;
const struct Chord chord_123 PROGMEM = {H_THU3, SYM, &state_123, NULL, KC_BSLASH, 0, single_dance};
uint8_t state_124 = IDLE;
const struct Chord chord_124 PROGMEM = {H_TOP3, SYMBOL, &state_124, NULL, KC_DOT, 0, single_dance};
uint8_t state_125 = IDLE;
const struct Chord chord_125 PROGMEM = {H_TOP4, SYMBOL, &state_125, NULL, KC_ASTERISK, 0, single_dance};
uint8_t state_126 = IDLE;
const struct Chord chord_126 PROGMEM = {H_TOP5, SYMBOL, &state_126, NULL, KC_AMPERSAND, 0, single_dance};
uint8_t state_127 = IDLE;
const struct Chord chord_127 PROGMEM = {H_TOP6, SYMBOL, &state_127, NULL, KC_PLUS, 0, single_dance};
uint8_t state_128 = IDLE;
const struct Chord chord_128 PROGMEM = {H_TOP7, SYMBOL, &state_128, NULL, KC_ASTERISK, 0, single_dance};
uint8_t state_129 = IDLE;
const struct Chord chord_129 PROGMEM = {H_TOP8, SYMBOL, &state_129, NULL, KC_LBRACKET, 0, single_dance};
uint8_t state_130 = IDLE;
const struct Chord chord_130 PROGMEM = {H_TOP9, SYMBOL, &state_130, NULL, KC_CIRCUMFLEX, 0, single_dance};
uint8_t state_131 = IDLE;
const struct Chord chord_131 PROGMEM = {H_TOP10, SYMBOL, &state_131, NULL, KC_RBRACKET, 0, single_dance};
uint8_t state_132 = IDLE;
const struct Chord chord_132 PROGMEM = {H_TOP12, SYMBOL, &state_132, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_133 = IDLE;
const struct Chord chord_133 PROGMEM = {H_TOP3 + H_BOT3, SYMBOL, &state_133, NULL, KC_QUESTION, 0, single_dance};
uint8_t state_134 = IDLE;
const struct Chord chord_134 PROGMEM = {H_TOP4 + H_BOT4, SYMBOL, &state_134, NULL, KC_EXCLAIM, 0, single_dance};
uint8_t state_135 = IDLE;
const struct Chord chord_135 PROGMEM = {H_TOP5 + H_BOT5, SYMBOL, &state_135, NULL, KC_SLASH, 0, single_dance};
uint8_t state_136 = IDLE;
const struct Chord chord_136 PROGMEM = {H_TOP6 + H_BOT6, SYMBOL, &state_136, NULL, KC_PIPE, 0, single_dance};
uint8_t state_137 = IDLE;
const struct Chord chord_137 PROGMEM = {H_TOP7 + H_BOT7, SYMBOL, &state_137, NULL, KC_QUESTION, 0, single_dance};
uint8_t state_138 = IDLE;
const struct Chord chord_138 PROGMEM = {H_TOP8 + H_BOT8, SYMBOL, &state_138, NULL, KC_LPRN, 0, single_dance};
uint8_t state_139 = IDLE;
const struct Chord chord_139 PROGMEM = {H_TOP9 + H_BOT9, SYMBOL, &state_139, NULL, KC_DOLLAR, 0, single_dance};
uint8_t state_140 = IDLE;
const struct Chord chord_140 PROGMEM = {H_TOP10 + H_BOT10, SYMBOL, &state_140, NULL, KC_RPRN, 0, single_dance};
uint8_t state_141 = IDLE;
const struct Chord chord_141 PROGMEM = {H_BOT3, SYMBOL, &state_141, NULL, KC_LEFT_ANGLE_BRACKET, 0, single_dance};
uint8_t state_142 = IDLE;
const struct Chord chord_142 PROGMEM = {H_BOT4, SYMBOL, &state_142, NULL, KC_RIGHT_ANGLE_BRACKET, 0, single_dance};
uint8_t state_143 = IDLE;
const struct Chord chord_143 PROGMEM = {H_BOT5, SYMBOL, &state_143, NULL, KC_PERCENT, 0, single_dance};
uint8_t state_144 = IDLE;
const struct Chord chord_144 PROGMEM = {H_BOT6, SYMBOL, &state_144, NULL, KC_AT, 0, single_dance};
uint8_t state_145 = IDLE;
const struct Chord chord_145 PROGMEM = {H_BOT7, SYMBOL, &state_145, NULL, KC_PIPE, 0, single_dance};
uint8_t state_146 = IDLE;
const struct Chord chord_146 PROGMEM = {H_BOT8, SYMBOL, &state_146, NULL, KC_LEFT_CURLY_BRACE, 0, single_dance};
uint8_t state_147 = IDLE;
const struct Chord chord_147 PROGMEM = {H_BOT9, SYMBOL, &state_147, NULL, KC_HASH, 0, single_dance};
uint8_t state_148 = IDLE;
const struct Chord chord_148 PROGMEM = {H_BOT10, SYMBOL, &state_148, NULL, KC_RIGHT_CURLY_BRACE, 0, single_dance};
uint8_t state_149 = IDLE;
const struct Chord chord_149 PROGMEM = {H_THU1, SYMBOL, &state_149, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_150 = IDLE;
const struct Chord chord_150 PROGMEM = {H_THU2, SYMBOL, &state_150, NULL, KC_EQUAL, 0, single_dance};
uint8_t state_151 = IDLE;
const struct Chord chord_151 PROGMEM = {H_THU3, SYMBOL, &state_151, NULL, KC_BSLASH, 0, single_dance};
uint8_t state_152 = IDLE;
const struct Chord chord_152 PROGMEM = {H_THU5, SYMBOL, &state_152, NULL, KC_SPC, 0, single_dance};
uint8_t state_153 = IDLE;
const struct Chord chord_153 PROGMEM = {H_THU6, SYMBOL, &state_153, NULL, KC_DEL, 0, single_dance};
uint8_t state_154 = IDLE;
const struct Chord chord_154 PROGMEM = {H_TOP3, NUM, &state_154, NULL, KC_A, 0, single_dance};
uint8_t state_155 = IDLE;
const struct Chord chord_155 PROGMEM = {H_TOP4, NUM, &state_155, NULL, KC_B, 0, single_dance};
uint8_t state_156 = IDLE;
const struct Chord chord_156 PROGMEM = {H_TOP5, NUM, &state_156, NULL, KC_C, 0, single_dance};
uint8_t state_157 = IDLE;
const struct Chord chord_157 PROGMEM = {H_TOP7, NUM, &state_157, NULL, KC_SLASH, 0, single_dance};
uint8_t state_158 = IDLE;
const struct Chord chord_158 PROGMEM = {H_TOP8, NUM, &state_158, NULL, KC_4, 0, single_dance};
uint8_t state_159 = IDLE;
const struct Chord chord_159 PROGMEM = {H_TOP9, NUM, &state_159, NULL, KC_5, 0, single_dance};
uint8_t state_160 = IDLE;
const struct Chord chord_160 PROGMEM = {H_TOP10, NUM, &state_160, NULL, KC_9, 0, single_dance};
uint8_t state_161 = IDLE;
const struct Chord chord_161 PROGMEM = {H_TOP11, NUM, &state_161, NULL, KC_ASTERISK, 0, single_dance};
uint8_t state_162 = IDLE;
const struct Chord chord_162 PROGMEM = {H_TOP2 + H_BOT2, NUM, &state_162, NULL, KC_LGUI, 0, single_dance};
uint8_t state_163 = IDLE;
const struct Chord chord_163 PROGMEM = {H_TOP3 + H_BOT3, NUM, &state_163, NULL, KC_D, KC_LCTL, key_mod_dance};
uint8_t state_164 = IDLE;
const struct Chord chord_164 PROGMEM = {H_TOP4 + H_BOT4, NUM, &state_164, NULL, KC_E, KC_LALT, key_mod_dance};
uint8_t state_165 = IDLE;
uint8_t counter_165 = 0;
const struct Chord chord_165 PROGMEM = {H_TOP5 + H_BOT5, NUM, &state_165, &counter_165, KC_F, KC_LSFT, key_key_dance};
uint8_t state_166 = IDLE;
const struct Chord chord_166 PROGMEM = {H_TOP7 + H_BOT7, NUM, &state_166, NULL, KC_DOT, 0, single_dance};
uint8_t state_167 = IDLE;
const struct Chord chord_167 PROGMEM = {H_TOP8 + H_BOT8, NUM, &state_167, NULL, KC_1, 0, single_dance};
uint8_t state_168 = IDLE;
const struct Chord chord_168 PROGMEM = {H_TOP9 + H_BOT9, NUM, &state_168, NULL, KC_2, 0, single_dance};
uint8_t state_169 = IDLE;
const struct Chord chord_169 PROGMEM = {H_TOP10 + H_BOT10, NUM, &state_169, NULL, KC_3, 0, single_dance};
uint8_t state_170 = IDLE;
const struct Chord chord_170 PROGMEM = {H_TOP11 + H_BOT11, NUM, &state_170, NULL, KC_MINUS, 0, single_dance};
uint8_t state_171 = IDLE;
const struct Chord chord_171 PROGMEM = {H_BOT3, NUM, &state_171, NULL, KC_LBRACKET, 0, single_dance};
uint8_t state_172 = IDLE;
const struct Chord chord_172 PROGMEM = {H_BOT4, NUM, &state_172, NULL, KC_RBRACKET, 0, single_dance};
uint8_t state_173 = IDLE;
const struct Chord chord_173 PROGMEM = {H_BOT5, NUM, &state_173, NULL, KC_G, 0, single_dance};
uint8_t state_174 = IDLE;
const struct Chord chord_174 PROGMEM = {H_BOT8, NUM, &state_174, NULL, KC_8, 0, single_dance};
uint8_t state_175 = IDLE;
const struct Chord chord_175 PROGMEM = {H_BOT9, NUM, &state_175, NULL, KC_6, 0, single_dance};
uint8_t state_176 = IDLE;
const struct Chord chord_176 PROGMEM = {H_BOT10, NUM, &state_176, NULL, KC_7, 0, single_dance};
uint8_t state_177 = IDLE;
const struct Chord chord_177 PROGMEM = {H_BOT11, NUM, &state_177, NULL, KC_PLUS, 0, single_dance};
uint8_t state_178 = IDLE;
const struct Chord chord_178 PROGMEM = {H_BOT12, NUM, &state_178, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_179 = IDLE;
const struct Chord chord_179 PROGMEM = {H_THU1, NUM, &state_179, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_180 = IDLE;
const struct Chord chord_180 PROGMEM = {H_THU4, NUM, &state_180, NULL, KC_BSLASH, 0, single_dance};
uint8_t state_181 = IDLE;
const struct Chord chord_181 PROGMEM = {H_THU5, NUM, &state_181, NULL, KC_0, 0, single_dance};
uint8_t state_182 = IDLE;
const struct Chord chord_182 PROGMEM = {H_THU6, NUM, &state_182, NULL, KC_EQUAL, 0, single_dance};
uint8_t state_183 = IDLE;
const struct Chord chord_183 PROGMEM = {H_TOP1, FNC, &state_183, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_184 = IDLE;
const struct Chord chord_184 PROGMEM = {H_TOP8, FNC, &state_184, NULL, KC_F4, 0, single_dance};
uint8_t state_185 = IDLE;
const struct Chord chord_185 PROGMEM = {H_TOP9, FNC, &state_185, NULL, KC_F5, 0, single_dance};
uint8_t state_186 = IDLE;
const struct Chord chord_186 PROGMEM = {H_TOP10, FNC, &state_186, NULL, KC_F9, 0, single_dance};
uint8_t state_187 = IDLE;
const struct Chord chord_187 PROGMEM = {H_TOP11, FNC, &state_187, NULL, KC_F12, 0, single_dance};
uint8_t state_188 = IDLE;
const struct Chord chord_188 PROGMEM = {H_TOP2 + H_BOT2, FNC, &state_188, NULL, KC_LGUI, 0, single_dance};
uint8_t state_189 = IDLE;
const struct Chord chord_189 PROGMEM = {H_TOP3 + H_BOT3, FNC, &state_189, NULL, KC_LCTL, 0, single_dance};
uint8_t state_190 = IDLE;
const struct Chord chord_190 PROGMEM = {H_TOP4 + H_BOT4, FNC, &state_190, NULL, KC_LALT, 0, single_dance};
uint8_t state_191 = IDLE;
const struct Chord chord_191 PROGMEM = {H_TOP5 + H_BOT5, FNC, &state_191, NULL, KC_LSFT, 0, single_dance};
uint8_t state_192 = IDLE;
const struct Chord chord_192 PROGMEM = {H_TOP8 + H_BOT8, FNC, &state_192, NULL, KC_F1, 0, single_dance};
uint8_t state_193 = IDLE;
const struct Chord chord_193 PROGMEM = {H_TOP9 + H_BOT9, FNC, &state_193, NULL, KC_F2, 0, single_dance};
uint8_t state_194 = IDLE;
const struct Chord chord_194 PROGMEM = {H_TOP10 + H_BOT10, FNC, &state_194, NULL, KC_F3, 0, single_dance};
uint8_t state_195 = IDLE;
const struct Chord chord_195 PROGMEM = {H_TOP11 + H_BOT11, FNC, &state_195, NULL, KC_F11, 0, single_dance};
uint8_t state_196 = IDLE;
const struct Chord chord_196 PROGMEM = {H_BOT8, FNC, &state_196, NULL, KC_F8, 0, single_dance};
uint8_t state_197 = IDLE;
const struct Chord chord_197 PROGMEM = {H_BOT9, FNC, &state_197, NULL, KC_F6, 0, single_dance};
uint8_t state_198 = IDLE;
const struct Chord chord_198 PROGMEM = {H_BOT10, FNC, &state_198, NULL, KC_F7, 0, single_dance};
uint8_t state_199 = IDLE;
const struct Chord chord_199 PROGMEM = {H_BOT11, FNC, &state_199, NULL, KC_F10, 0, single_dance};
uint8_t state_200 = IDLE;
const struct Chord chord_200 PROGMEM = {H_THU1, FNC, &state_200, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_201 = IDLE;
const struct Chord chord_201 PROGMEM = {H_TOP8, NAV, &state_201, NULL, KC_HOME, 0, single_dance};
uint8_t state_202 = IDLE;
const struct Chord chord_202 PROGMEM = {H_TOP9, NAV, &state_202, NULL, KC_UP, 0, single_dance};
uint8_t state_203 = IDLE;
const struct Chord chord_203 PROGMEM = {H_TOP10, NAV, &state_203, NULL, KC_END, 0, single_dance};
uint8_t state_204 = IDLE;
const struct Chord chord_204 PROGMEM = {H_TOP11, NAV, &state_204, NULL, KC_PGUP, 0, single_dance};
uint8_t state_205 = IDLE;
const struct Chord chord_205 PROGMEM = {H_TOP3 + H_BOT3, NAV, &state_205, NULL, KC_LGUI, 0, single_dance};
uint8_t state_206 = IDLE;
const struct Chord chord_206 PROGMEM = {H_TOP4 + H_BOT4, NAV, &state_206, NULL, KC_LCTL, 0, single_dance};
uint8_t state_207 = IDLE;
const struct Chord chord_207 PROGMEM = {H_TOP5 + H_BOT5, NAV, &state_207, NULL, KC_LALT, 0, single_dance};
uint8_t state_208 = IDLE;
const struct Chord chord_208 PROGMEM = {H_TOP6 + H_BOT6, NAV, &state_208, NULL, KC_LSFT, 0, single_dance};
uint8_t state_209 = IDLE;
const struct Chord chord_209 PROGMEM = {H_TOP12 + H_BOT12, NAV, &state_209, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_210 = IDLE;
const struct Chord chord_210 PROGMEM = {H_BOT8, NAV, &state_210, NULL, KC_LEFT, 0, single_dance};
uint8_t state_211 = IDLE;
const struct Chord chord_211 PROGMEM = {H_BOT9, NAV, &state_211, NULL, KC_DOWN, 0, single_dance};
uint8_t state_212 = IDLE;
const struct Chord chord_212 PROGMEM = {H_BOT10, NAV, &state_212, NULL, KC_RIGHT, 0, single_dance};
uint8_t state_213 = IDLE;
const struct Chord chord_213 PROGMEM = {H_BOT11, NAV, &state_213, NULL, KC_PGDN, 0, single_dance};
uint8_t state_214 = IDLE;
const struct Chord chord_214 PROGMEM = {H_THU1, NAV, &state_214, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_215 = IDLE;
const struct Chord chord_215 PROGMEM = {H_TOP8, MOUSE, &state_215, NULL, KC_BTN1, 0, single_dance};
uint8_t state_216 = IDLE;
const struct Chord chord_216 PROGMEM = {H_TOP9, MOUSE, &state_216, NULL, KC_MS_U, 0, single_dance};
uint8_t state_217 = IDLE;
const struct Chord chord_217 PROGMEM = {H_TOP10, MOUSE, &state_217, NULL, KC_BTN2, 0, single_dance};
uint8_t state_218 = IDLE;
const struct Chord chord_218 PROGMEM = {H_TOP11, MOUSE, &state_218, NULL, KC_WH_U, 0, single_dance};
uint8_t state_219 = IDLE;
const struct Chord chord_219 PROGMEM = {H_TOP1 + H_BOT1, MOUSE, &state_219, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_220 = IDLE;
const struct Chord chord_220 PROGMEM = {H_TOP3 + H_BOT3, MOUSE, &state_220, NULL, KC_LGUI, 0, single_dance};
uint8_t state_221 = IDLE;
const struct Chord chord_221 PROGMEM = {H_TOP4 + H_BOT4, MOUSE, &state_221, NULL, KC_LCTL, 0, single_dance};
uint8_t state_222 = IDLE;
const struct Chord chord_222 PROGMEM = {H_TOP5 + H_BOT5, MOUSE, &state_222, NULL, KC_LALT, 0, single_dance};
uint8_t state_223 = IDLE;
const struct Chord chord_223 PROGMEM = {H_TOP6 + H_BOT6, MOUSE, &state_223, NULL, KC_LSFT, 0, single_dance};
uint8_t state_224 = IDLE;
const struct Chord chord_224 PROGMEM = {H_BOT8, MOUSE, &state_224, NULL, KC_MS_L, 0, single_dance};
uint8_t state_225 = IDLE;
const struct Chord chord_225 PROGMEM = {H_BOT9, MOUSE, &state_225, NULL, KC_MS_D, 0, single_dance};
uint8_t state_226 = IDLE;
const struct Chord chord_226 PROGMEM = {H_BOT10, MOUSE, &state_226, NULL, KC_MS_R, 0, single_dance};
uint8_t state_227 = IDLE;
const struct Chord chord_227 PROGMEM = {H_BOT11, MOUSE, &state_227, NULL, KC_WH_D, 0, single_dance};
uint8_t state_228 = IDLE;
const struct Chord chord_228 PROGMEM = {H_THU1, MOUSE, &state_228, NULL, BEAKL, 0, perm_pseudolayer};

const struct Chord* const list_of_chords[] PROGMEM = {
    &chord_0, &chord_1, &chord_2, &chord_3, &chord_4, &chord_5, &chord_6, &chord_7, &chord_8, &chord_9, &chord_10, &chord_11, &chord_12, &chord_13, &chord_14, &chord_15, &chord_16, &chord_17, &chord_18, &chord_19, &chord_20, &chord_21, &chord_22, &chord_23, &chord_24, &chord_25, &chord_26, &chord_27, &chord_28, &chord_29, &chord_30, &chord_31, &chord_32, &chord_33, &chord_34, &chord_35, &chord_36, &chord_37, &chord_38, &chord_39, &chord_40, &chord_41, &chord_42, &chord_43, &chord_44, &chord_45, &chord_46, &chord_47, &chord_48, &chord_49, &chord_50, &chord_51, &chord_52, &chord_53, &chord_54, &chord_55, &chord_56, &chord_57, &chord_58, &chord_59, &chord_60, &chord_61, &chord_62, &chord_63, &chord_64, &chord_65, &chord_66, &chord_67, &chord_68, &chord_69, &chord_70, &chord_71, &chord_72, &chord_73, &chord_74, &chord_75, &chord_76, &chord_77, &chord_78, &chord_79, &chord_80, &chord_81, &chord_82, &chord_83, &chord_84, &chord_85, &chord_86, &chord_87, &chord_88, &chord_89, &chord_90, &chord_91, &chord_92, &chord_93, &chord_94, &chord_95, &chord_96, &chord_97, &chord_98, &chord_99, &chord_100, &chord_101, &chord_102, &chord_103, &chord_104, &chord_105, &chord_106, &chord_107, &chord_108, &chord_109, &chord_110, &chord_111, &chord_112, &chord_113, &chord_114, &chord_115, &chord_116, &chord_117, &chord_118, &chord_119, &chord_120, &chord_121, &chord_122, &chord_123, &chord_124, &chord_125, &chord_126, &chord_127, &chord_128, &chord_129, &chord_130, &chord_131, &chord_132, &chord_133, &chord_134, &chord_135, &chord_136, &chord_137, &chord_138, &chord_139, &chord_140, &chord_141, &chord_142, &chord_143, &chord_144, &chord_145, &chord_146, &chord_147, &chord_148, &chord_149, &chord_150, &chord_151, &chord_152, &chord_153, &chord_154, &chord_155, &chord_156, &chord_157, &chord_158, &chord_159, &chord_160, &chord_161, &chord_162, &chord_163, &chord_164, &chord_165, &chord_166, &chord_167, &chord_168, &chord_169, &chord_170, &chord_171, &chord_172, &chord_173, &chord_174, &chord_175, &chord_176, &chord_177, &chord_178, &chord_179, &chord_180, &chord_181, &chord_182, &chord_183, &chord_184, &chord_185, &chord_186, &chord_187, &chord_188, &chord_189, &chord_190, &chord_191, &chord_192, &chord_193, &chord_194, &chord_195, &chord_196, &chord_197, &chord_198, &chord_199, &chord_200, &chord_201, &chord_202, &chord_203, &chord_204, &chord_205, &chord_206, &chord_207, &chord_208, &chord_209, &chord_210, &chord_211, &chord_212, &chord_213, &chord_214, &chord_215, &chord_216, &chord_217, &chord_218, &chord_219, &chord_220, &chord_221, &chord_222, &chord_223, &chord_224, &chord_225, &chord_226, &chord_227, &chord_228
};

const uint16_t** const leader_triggers PROGMEM = NULL;
void (*leader_functions[]) (void) = {};

#define NUMBER_OF_CHORDS 229
