...
const struct Chord chord_39 PROGMEM = {H_TOP2 + H_BOT3, BEAKL, &state_39, NULL, 0, 0, string_in};
...
const struct Chord chord_42 PROGMEM = {H_TOP6 + H_TOP8 + H_BOT8, BEAKL, &state_42, NULL, KC_UNDERSCORE, 0, single_dance};
uint8_t state_43 = IDLE;
const struct Chord chord_43 PROGMEM = {H_BOT6 + H_TOP8 + H_BOT8, BEAKL, &state_43, NULL, KC_DOUBLE_QUOTE, 0, single_dance};
uint8_t state_44 = IDLE;
const struct Chord chord_44 PROGMEM = {H_TOP5 + H_BOT5 + H_THU5, BEAKL, &state_44, NULL, KC_DEL, 0, single_dance};
uint8_t state_45 = IDLE;
const struct Chord chord_45 PROGMEM = {H_THU5 + H_THU6, BEAKL, &state_45, NULL, KC_DEL, 0, single_dance};
uint8_t state_46 = IDLE;
uint8_t counter_46 = 0;
const struct Chord chord_46 PROGMEM = {H_THU1, BEAKL, &state_46, &counter_46, KC_ESC, FNC, key_layer_dance};
uint8_t state_47 = IDLE;
uint8_t counter_47 = 0;
const struct Chord chord_47 PROGMEM = {H_THU2, BEAKL, &state_47, &counter_47, KC_I, REGEX, key_layer_dance};
uint8_t state_48 = IDLE;
uint8_t counter_48 = 0;
const struct Chord chord_48 PROGMEM = {H_THU3, BEAKL, &state_48, &counter_48, KC_TAB, NUM, key_layer_dance};
uint8_t state_49 = IDLE;
uint8_t counter_49 = 0;
const struct Chord chord_49 PROGMEM = {H_THU4, BEAKL, &state_49, &counter_49, KC_ENTER, NAV, key_layer_dance};
uint8_t state_50 = IDLE;
uint8_t counter_50 = 0;
const struct Chord chord_50 PROGMEM = {H_THU5, BEAKL, &state_50, &counter_50, KC_SPC, SYM, key_layer_dance};
uint8_t state_51 = IDLE;
uint8_t counter_51 = 0;
const struct Chord chord_51 PROGMEM = {H_THU6, BEAKL, &state_51, &counter_51, KC_BSPC, MOUSE, key_layer_dance};
uint8_t state_52 = IDLE;
const struct Chord chord_52 PROGMEM = {H_TOP2, CAPS, &state_52, NULL, KC_COLON, 0, single_dance};
...
const struct Chord chord_53 PROGMEM = {H_TOP3, CAPS, &state_53, &counter_53, 0, 0, function_53};
...
const struct Chord chord_54 PROGMEM = {H_TOP4, CAPS, &state_54, &counter_54, 0, 0, function_54};
...
const struct Chord chord_55 PROGMEM = {H_TOP5, CAPS, &state_55, &counter_55, 0, 0, function_55};
uint8_t state_56 = IDLE;
const struct Chord chord_56 PROGMEM = {H_TOP6, CAPS, &state_56, NULL, KC_MINUS, 0, single_dance};
...
const struct Chord chord_57 PROGMEM = {H_TOP7, CAPS, &state_57, &counter_57, 0, 0, function_57};
...
const struct Chord chord_58 PROGMEM = {H_TOP8, CAPS, &state_58, &counter_58, 0, 0, function_58};
...
const struct Chord chord_59 PROGMEM = {H_TOP9, CAPS, &state_59, &counter_59, 0, 0, function_59};
...
const struct Chord chord_60 PROGMEM = {H_TOP10, CAPS, &state_60, &counter_60, 0, 0, function_60};
...
const struct Chord chord_61 PROGMEM = {H_TOP11, CAPS, &state_61, &counter_61, 0, 0, function_61};
...
const struct Chord chord_62 PROGMEM = {H_TOP2 + H_BOT2, CAPS, &state_62, &counter_62, 0, 0, function_62};
...
const struct Chord chord_63 PROGMEM = {H_TOP3 + H_BOT3, CAPS, &state_63, &counter_63, 0, 0, function_63};
...
const struct Chord chord_64 PROGMEM = {H_TOP4 + H_BOT4, CAPS, &state_64, &counter_64, 0, 0, function_64};
...
const struct Chord chord_65 PROGMEM = {H_TOP5 + H_BOT5, CAPS, &state_65, &counter_65, 0, 0, function_65};
...
const struct Chord chord_66 PROGMEM = {H_TOP6 + H_BOT6, CAPS, &state_66, &counter_66, 0, 0, function_66};
...
const struct Chord chord_67 PROGMEM = {H_TOP7 + H_BOT7, CAPS, &state_67, &counter_67, 0, 0, function_67};
...
const struct Chord chord_68 PROGMEM = {H_TOP8 + H_BOT8, CAPS, &state_68, &counter_68, 0, 0, function_68};
...
const struct Chord chord_69 PROGMEM = {H_TOP9 + H_BOT9, CAPS, &state_69, &counter_69, 0, 0, function_69};
...
const struct Chord chord_70 PROGMEM = {H_TOP10 + H_BOT10, CAPS, &state_70, &counter_70, 0, 0, function_70};
...
const struct Chord chord_71 PROGMEM = {H_TOP11 + H_BOT11, CAPS, &state_71, &counter_71, 0, 0, function_71};
...
const struct Chord chord_72 PROGMEM = {H_BOT2, CAPS, &state_72, &counter_72, 0, 0, function_72};
uint8_t state_73 = IDLE;
const struct Chord chord_73 PROGMEM = {H_BOT3, CAPS, &state_73, NULL, KC_COMMA, 0, single_dance};
uint8_t state_74 = IDLE;
const struct Chord chord_74 PROGMEM = {H_BOT4, CAPS, &state_74, NULL, KC_DOT, 0, single_dance};
...
const struct Chord chord_75 PROGMEM = {H_BOT5, CAPS, &state_75, &counter_75, 0, 0, function_75};
uint8_t state_76 = IDLE;
const struct Chord chord_76 PROGMEM = {H_BOT6, CAPS, &state_76, NULL, KC_QUOTE, 0, single_dance};
...
const struct Chord chord_77 PROGMEM = {H_BOT7, CAPS, &state_77, &counter_77, 0, 0, function_77};
...
const struct Chord chord_78 PROGMEM = {H_BOT8, CAPS, &state_78, &counter_78, 0, 0, function_78};
...
const struct Chord chord_79 PROGMEM = {H_BOT9, CAPS, &state_79, &counter_79, 0, 0, function_79};
...
const struct Chord chord_80 PROGMEM = {H_BOT10, CAPS, &state_80, &counter_80, 0, 0, function_80};
...
const struct Chord chord_81 PROGMEM = {H_BOT11, CAPS, &state_81, &counter_81, 0, 0, function_81};
...
const struct Chord chord_82 PROGMEM = {H_THU2, CAPS, &state_82, &counter_82, 0, 0, function_82};
uint8_t state_83 = IDLE;
const struct Chord chord_83 PROGMEM = {H_TOP7, REGEX, &state_83, NULL, KC_ASTERISK, 0, single_dance};
uint8_t state_84 = IDLE;
const struct Chord chord_84 PROGMEM = {H_TOP8, REGEX, &state_84, NULL, KC_LBRACKET, 0, single_dance};
uint8_t state_85 = IDLE;
const struct Chord chord_85 PROGMEM = {H_TOP9, REGEX, &state_85, NULL, KC_CIRCUMFLEX, 0, single_dance};
uint8_t state_86 = IDLE;
const struct Chord chord_86 PROGMEM = {H_TOP10, REGEX, &state_86, NULL, KC_RBRACKET, 0, single_dance};
uint8_t state_87 = IDLE;
const struct Chord chord_87 PROGMEM = {H_TOP7 + H_BOT7, REGEX, &state_87, NULL, KC_QUESTION, 0, single_dance};
uint8_t state_88 = IDLE;
const struct Chord chord_88 PROGMEM = {H_TOP8 + H_BOT8, REGEX, &state_88, NULL, KC_LPRN, 0, single_dance};
uint8_t state_89 = IDLE;
const struct Chord chord_89 PROGMEM = {H_TOP9 + H_BOT9, REGEX, &state_89, NULL, KC_DOLLAR, 0, single_dance};
uint8_t state_90 = IDLE;
const struct Chord chord_90 PROGMEM = {H_TOP10 + H_BOT10, REGEX, &state_90, NULL, KC_RPRN, 0, single_dance};
uint8_t state_91 = IDLE;
const struct Chord chord_91 PROGMEM = {H_BOT7, REGEX, &state_91, NULL, KC_PIPE, 0, single_dance};
uint8_t state_92 = IDLE;
const struct Chord chord_92 PROGMEM = {H_BOT8, REGEX, &state_92, NULL, KC_LEFT_CURLY_BRACE, 0, single_dance};
uint8_t state_93 = IDLE;
const struct Chord chord_93 PROGMEM = {H_BOT9, REGEX, &state_93, NULL, KC_HASH, 0, single_dance};
uint8_t state_94 = IDLE;
const struct Chord chord_94 PROGMEM = {H_BOT10, REGEX, &state_94, NULL, KC_RIGHT_CURLY_BRACE, 0, single_dance};
uint8_t state_95 = IDLE;
const struct Chord chord_95 PROGMEM = {H_THU5, REGEX, &state_95, NULL, KC_BSLASH, 0, single_dance};
uint8_t state_96 = IDLE;
const struct Chord chord_96 PROGMEM = {H_THU6, REGEX, &state_96, NULL, KC_DEL, 0, single_dance};
uint8_t state_97 = IDLE;
const struct Chord chord_97 PROGMEM = {H_TOP7 + H_TOP8, REGEX, &state_97, NULL, 1, 0, string_in};
uint8_t state_98 = IDLE;
const struct Chord chord_98 PROGMEM = {H_TOP3, SYM, &state_98, NULL, KC_DOT, 0, single_dance};
uint8_t state_99 = IDLE;
const struct Chord chord_99 PROGMEM = {H_TOP4, SYM, &state_99, NULL, KC_ASTERISK, 0, single_dance};
uint8_t state_100 = IDLE;
const struct Chord chord_100 PROGMEM = {H_TOP5, SYM, &state_100, NULL, KC_AMPERSAND, 0, single_dance};
uint8_t state_101 = IDLE;
const struct Chord chord_101 PROGMEM = {H_TOP6, SYM, &state_101, NULL, KC_PLUS, 0, single_dance};
uint8_t state_102 = IDLE;
const struct Chord chord_102 PROGMEM = {H_TOP3 + H_BOT3, SYM, &state_102, NULL, KC_QUESTION, 0, single_dance};
uint8_t state_103 = IDLE;
const struct Chord chord_103 PROGMEM = {H_TOP4 + H_BOT4, SYM, &state_103, NULL, KC_EXCLAIM, 0, single_dance};
uint8_t state_104 = IDLE;
const struct Chord chord_104 PROGMEM = {H_TOP5 + H_BOT5, SYM, &state_104, NULL, KC_SLASH, 0, single_dance};
uint8_t state_105 = IDLE;
const struct Chord chord_105 PROGMEM = {H_TOP6 + H_BOT6, SYM, &state_105, NULL, KC_PIPE, 0, single_dance};
uint8_t state_106 = IDLE;
const struct Chord chord_106 PROGMEM = {H_BOT3, SYM, &state_106, NULL, KC_LEFT_ANGLE_BRACKET, 0, single_dance};
uint8_t state_107 = IDLE;
const struct Chord chord_107 PROGMEM = {H_BOT4, SYM, &state_107, NULL, KC_RIGHT_ANGLE_BRACKET, 0, single_dance};
uint8_t state_108 = IDLE;
const struct Chord chord_108 PROGMEM = {H_BOT5, SYM, &state_108, NULL, KC_PERCENT, 0, single_dance};
uint8_t state_109 = IDLE;
const struct Chord chord_109 PROGMEM = {H_BOT6, SYM, &state_109, NULL, KC_AT, 0, single_dance};
uint8_t state_110 = IDLE;
const struct Chord chord_110 PROGMEM = {H_THU2, SYM, &state_110, NULL, KC_EQUAL, 0, single_dance};
uint8_t state_111 = IDLE;
const struct Chord chord_111 PROGMEM = {H_THU3, SYM, &state_111, NULL, KC_BSLASH, 0, single_dance};
uint8_t state_112 = IDLE;
const struct Chord chord_112 PROGMEM = {H_BOT2 + H_BOT3, SYM, &state_112, NULL, 2, 0, string_in};
uint8_t state_113 = IDLE;
const struct Chord chord_113 PROGMEM = {H_BOT4 + H_BOT5, SYM, &state_113, NULL, 3, 0, string_in};
uint8_t state_114 = IDLE;
const struct Chord chord_114 PROGMEM = {H_THU1 + H_THU2, SYM, &state_114, NULL, 4, 0, string_in};
uint8_t state_115 = IDLE;
const struct Chord chord_115 PROGMEM = {H_TOP3, SYMBOL, &state_115, NULL, KC_DOT, 0, single_dance};
uint8_t state_116 = IDLE;
const struct Chord chord_116 PROGMEM = {H_TOP4, SYMBOL, &state_116, NULL, KC_ASTERISK, 0, single_dance};
uint8_t state_117 = IDLE;
const struct Chord chord_117 PROGMEM = {H_TOP5, SYMBOL, &state_117, NULL, KC_AMPERSAND, 0, single_dance};
uint8_t state_118 = IDLE;
const struct Chord chord_118 PROGMEM = {H_TOP6, SYMBOL, &state_118, NULL, KC_PLUS, 0, single_dance};
uint8_t state_119 = IDLE;
const struct Chord chord_119 PROGMEM = {H_TOP7, SYMBOL, &state_119, NULL, KC_ASTERISK, 0, single_dance};
uint8_t state_120 = IDLE;
const struct Chord chord_120 PROGMEM = {H_TOP8, SYMBOL, &state_120, NULL, KC_LBRACKET, 0, single_dance};
uint8_t state_121 = IDLE;
const struct Chord chord_121 PROGMEM = {H_TOP9, SYMBOL, &state_121, NULL, KC_CIRCUMFLEX, 0, single_dance};
uint8_t state_122 = IDLE;
const struct Chord chord_122 PROGMEM = {H_TOP10, SYMBOL, &state_122, NULL, KC_RBRACKET, 0, single_dance};
uint8_t state_123 = IDLE;
const struct Chord chord_123 PROGMEM = {H_TOP12, SYMBOL, &state_123, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_124 = IDLE;
const struct Chord chord_124 PROGMEM = {H_TOP3 + H_BOT3, SYMBOL, &state_124, NULL, KC_QUESTION, 0, single_dance};
uint8_t state_125 = IDLE;
const struct Chord chord_125 PROGMEM = {H_TOP4 + H_BOT4, SYMBOL, &state_125, NULL, KC_EXCLAIM, 0, single_dance};
uint8_t state_126 = IDLE;
const struct Chord chord_126 PROGMEM = {H_TOP5 + H_BOT5, SYMBOL, &state_126, NULL, KC_SLASH, 0, single_dance};
uint8_t state_127 = IDLE;
const struct Chord chord_127 PROGMEM = {H_TOP6 + H_BOT6, SYMBOL, &state_127, NULL, KC_PIPE, 0, single_dance};
uint8_t state_128 = IDLE;
const struct Chord chord_128 PROGMEM = {H_TOP7 + H_BOT7, SYMBOL, &state_128, NULL, KC_QUESTION, 0, single_dance};
uint8_t state_129 = IDLE;
const struct Chord chord_129 PROGMEM = {H_TOP8 + H_BOT8, SYMBOL, &state_129, NULL, KC_LPRN, 0, single_dance};
uint8_t state_130 = IDLE;
const struct Chord chord_130 PROGMEM = {H_TOP9 + H_BOT9, SYMBOL, &state_130, NULL, KC_DOLLAR, 0, single_dance};
uint8_t state_131 = IDLE;
const struct Chord chord_131 PROGMEM = {H_TOP10 + H_BOT10, SYMBOL, &state_131, NULL, KC_RPRN, 0, single_dance};
uint8_t state_132 = IDLE;
const struct Chord chord_132 PROGMEM = {H_BOT3, SYMBOL, &state_132, NULL, KC_LEFT_ANGLE_BRACKET, 0, single_dance};
uint8_t state_133 = IDLE;
const struct Chord chord_133 PROGMEM = {H_BOT4, SYMBOL, &state_133, NULL, KC_RIGHT_ANGLE_BRACKET, 0, single_dance};
uint8_t state_134 = IDLE;
const struct Chord chord_134 PROGMEM = {H_BOT5, SYMBOL, &state_134, NULL, KC_PERCENT, 0, single_dance};
uint8_t state_135 = IDLE;
const struct Chord chord_135 PROGMEM = {H_BOT6, SYMBOL, &state_135, NULL, KC_AT, 0, single_dance};
uint8_t state_136 = IDLE;
const struct Chord chord_136 PROGMEM = {H_BOT7, SYMBOL, &state_136, NULL, KC_PIPE, 0, single_dance};
uint8_t state_137 = IDLE;
const struct Chord chord_137 PROGMEM = {H_BOT8, SYMBOL, &state_137, NULL, KC_LEFT_CURLY_BRACE, 0, single_dance};
uint8_t state_138 = IDLE;
const struct Chord chord_138 PROGMEM = {H_BOT9, SYMBOL, &state_138, NULL, KC_HASH, 0, single_dance};
uint8_t state_139 = IDLE;
const struct Chord chord_139 PROGMEM = {H_BOT10, SYMBOL, &state_139, NULL, KC_RIGHT_CURLY_BRACE, 0, single_dance};
uint8_t state_140 = IDLE;
const struct Chord chord_140 PROGMEM = {H_THU1, SYMBOL, &state_140, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_141 = IDLE;
const struct Chord chord_141 PROGMEM = {H_THU2, SYMBOL, &state_141, NULL, KC_EQUAL, 0, single_dance};
uint8_t state_142 = IDLE;
const struct Chord chord_142 PROGMEM = {H_THU3, SYMBOL, &state_142, NULL, KC_BSLASH, 0, single_dance};
uint8_t state_143 = IDLE;
const struct Chord chord_143 PROGMEM = {H_THU5, SYMBOL, &state_143, NULL, KC_SPC, 0, single_dance};
uint8_t state_144 = IDLE;
const struct Chord chord_144 PROGMEM = {H_THU6, SYMBOL, &state_144, NULL, KC_DEL, 0, single_dance};
uint8_t state_145 = IDLE;
const struct Chord chord_145 PROGMEM = {H_BOT2 + H_BOT3, SYMBOL, &state_145, NULL, 5, 0, string_in};
uint8_t state_146 = IDLE;
const struct Chord chord_146 PROGMEM = {H_BOT4 + H_BOT5, SYMBOL, &state_146, NULL, 6, 0, string_in};
uint8_t state_147 = IDLE;
const struct Chord chord_147 PROGMEM = {H_THU1 + H_THU2, SYMBOL, &state_147, NULL, 7, 0, string_in};
uint8_t state_148 = IDLE;
const struct Chord chord_148 PROGMEM = {H_TOP3, NUM, &state_148, NULL, KC_A, 0, single_dance};
uint8_t state_149 = IDLE;
const struct Chord chord_149 PROGMEM = {H_TOP4, NUM, &state_149, NULL, KC_B, 0, single_dance};
uint8_t state_150 = IDLE;
const struct Chord chord_150 PROGMEM = {H_TOP5, NUM, &state_150, NULL, KC_C, 0, single_dance};
uint8_t state_151 = IDLE;
const struct Chord chord_151 PROGMEM = {H_TOP7, NUM, &state_151, NULL, KC_SLASH, 0, single_dance};
uint8_t state_152 = IDLE;
const struct Chord chord_152 PROGMEM = {H_TOP8, NUM, &state_152, NULL, KC_4, 0, single_dance};
uint8_t state_153 = IDLE;
const struct Chord chord_153 PROGMEM = {H_TOP9, NUM, &state_153, NULL, KC_5, 0, single_dance};
uint8_t state_154 = IDLE;
const struct Chord chord_154 PROGMEM = {H_TOP10, NUM, &state_154, NULL, KC_9, 0, single_dance};
uint8_t state_155 = IDLE;
const struct Chord chord_155 PROGMEM = {H_TOP11, NUM, &state_155, NULL, KC_ASTERISK, 0, single_dance};
uint8_t state_156 = IDLE;
const struct Chord chord_156 PROGMEM = {H_TOP2 + H_BOT2, NUM, &state_156, NULL, KC_LGUI, 0, single_dance};
uint8_t state_157 = IDLE;
const struct Chord chord_157 PROGMEM = {H_TOP3 + H_BOT3, NUM, &state_157, NULL, KC_D, KC_LCTL, key_mod_dance};
uint8_t state_158 = IDLE;
const struct Chord chord_158 PROGMEM = {H_TOP4 + H_BOT4, NUM, &state_158, NULL, KC_E, KC_LALT, key_mod_dance};
uint8_t state_159 = IDLE;
uint8_t counter_159 = 0;
const struct Chord chord_159 PROGMEM = {H_TOP5 + H_BOT5, NUM, &state_159, &counter_159, KC_F, KC_LSFT, key_key_dance};
uint8_t state_160 = IDLE;
const struct Chord chord_160 PROGMEM = {H_TOP7 + H_BOT7, NUM, &state_160, NULL, KC_DOT, 0, single_dance};
uint8_t state_161 = IDLE;
const struct Chord chord_161 PROGMEM = {H_TOP8 + H_BOT8, NUM, &state_161, NULL, KC_1, 0, single_dance};
uint8_t state_162 = IDLE;
const struct Chord chord_162 PROGMEM = {H_TOP9 + H_BOT9, NUM, &state_162, NULL, KC_2, 0, single_dance};
uint8_t state_163 = IDLE;
const struct Chord chord_163 PROGMEM = {H_TOP10 + H_BOT10, NUM, &state_163, NULL, KC_3, 0, single_dance};
uint8_t state_164 = IDLE;
const struct Chord chord_164 PROGMEM = {H_TOP11 + H_BOT11, NUM, &state_164, NULL, KC_MINUS, 0, single_dance};
uint8_t state_165 = IDLE;
const struct Chord chord_165 PROGMEM = {H_BOT3, NUM, &state_165, NULL, KC_LBRACKET, 0, single_dance};
uint8_t state_166 = IDLE;
const struct Chord chord_166 PROGMEM = {H_BOT4, NUM, &state_166, NULL, KC_RBRACKET, 0, single_dance};
uint8_t state_167 = IDLE;
const struct Chord chord_167 PROGMEM = {H_BOT5, NUM, &state_167, NULL, KC_G, 0, single_dance};
uint8_t state_168 = IDLE;
const struct Chord chord_168 PROGMEM = {H_BOT8, NUM, &state_168, NULL, KC_8, 0, single_dance};
uint8_t state_169 = IDLE;
const struct Chord chord_169 PROGMEM = {H_BOT9, NUM, &state_169, NULL, KC_6, 0, single_dance};
uint8_t state_170 = IDLE;
const struct Chord chord_170 PROGMEM = {H_BOT10, NUM, &state_170, NULL, KC_7, 0, single_dance};
uint8_t state_171 = IDLE;
const struct Chord chord_171 PROGMEM = {H_BOT11, NUM, &state_171, NULL, KC_PLUS, 0, single_dance};
uint8_t state_172 = IDLE;
const struct Chord chord_172 PROGMEM = {H_BOT12, NUM, &state_172, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_173 = IDLE;
const struct Chord chord_173 PROGMEM = {H_THU1, NUM, &state_173, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_174 = IDLE;
const struct Chord chord_174 PROGMEM = {H_THU4, NUM, &state_174, NULL, KC_BSLASH, 0, single_dance};
uint8_t state_175 = IDLE;
const struct Chord chord_175 PROGMEM = {H_THU5, NUM, &state_175, NULL, KC_0, 0, single_dance};
uint8_t state_176 = IDLE;
const struct Chord chord_176 PROGMEM = {H_THU6, NUM, &state_176, NULL, KC_EQUAL, 0, single_dance};
uint8_t state_177 = IDLE;
const struct Chord chord_177 PROGMEM = {H_TOP7 + H_TOP8, NUM, &state_177, NULL, KC_COLON, 0, single_dance};
uint8_t state_178 = IDLE;
const struct Chord chord_178 PROGMEM = {H_BOT7 + H_BOT8, NUM, &state_178, NULL, KC_SCOLON, 0, single_dance};
uint8_t state_179 = IDLE;
const struct Chord chord_179 PROGMEM = {H_TOP1, FNC, &state_179, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_180 = IDLE;
const struct Chord chord_180 PROGMEM = {H_TOP8, FNC, &state_180, NULL, KC_F4, 0, single_dance};
uint8_t state_181 = IDLE;
const struct Chord chord_181 PROGMEM = {H_TOP9, FNC, &state_181, NULL, KC_F5, 0, single_dance};
uint8_t state_182 = IDLE;
const struct Chord chord_182 PROGMEM = {H_TOP10, FNC, &state_182, NULL, KC_F9, 0, single_dance};
uint8_t state_183 = IDLE;
const struct Chord chord_183 PROGMEM = {H_TOP11, FNC, &state_183, NULL, KC_F12, 0, single_dance};
uint8_t state_184 = IDLE;
const struct Chord chord_184 PROGMEM = {H_TOP2 + H_BOT2, FNC, &state_184, NULL, KC_LGUI, 0, single_dance};
uint8_t state_185 = IDLE;
const struct Chord chord_185 PROGMEM = {H_TOP3 + H_BOT3, FNC, &state_185, NULL, KC_LCTL, 0, single_dance};
uint8_t state_186 = IDLE;
const struct Chord chord_186 PROGMEM = {H_TOP4 + H_BOT4, FNC, &state_186, NULL, KC_LALT, 0, single_dance};
uint8_t state_187 = IDLE;
const struct Chord chord_187 PROGMEM = {H_TOP5 + H_BOT5, FNC, &state_187, NULL, KC_LSFT, 0, single_dance};
uint8_t state_188 = IDLE;
const struct Chord chord_188 PROGMEM = {H_TOP8 + H_BOT8, FNC, &state_188, NULL, KC_F1, 0, single_dance};
uint8_t state_189 = IDLE;
const struct Chord chord_189 PROGMEM = {H_TOP9 + H_BOT9, FNC, &state_189, NULL, KC_F2, 0, single_dance};
uint8_t state_190 = IDLE;
const struct Chord chord_190 PROGMEM = {H_TOP10 + H_BOT10, FNC, &state_190, NULL, KC_F3, 0, single_dance};
uint8_t state_191 = IDLE;
const struct Chord chord_191 PROGMEM = {H_TOP11 + H_BOT11, FNC, &state_191, NULL, KC_F11, 0, single_dance};
uint8_t state_192 = IDLE;
const struct Chord chord_192 PROGMEM = {H_BOT8, FNC, &state_192, NULL, KC_F8, 0, single_dance};
uint8_t state_193 = IDLE;
const struct Chord chord_193 PROGMEM = {H_BOT9, FNC, &state_193, NULL, KC_F6, 0, single_dance};
uint8_t state_194 = IDLE;
const struct Chord chord_194 PROGMEM = {H_BOT10, FNC, &state_194, NULL, KC_F7, 0, single_dance};
uint8_t state_195 = IDLE;
const struct Chord chord_195 PROGMEM = {H_BOT11, FNC, &state_195, NULL, KC_F10, 0, single_dance};
uint8_t state_196 = IDLE;
const struct Chord chord_196 PROGMEM = {H_THU1, FNC, &state_196, NULL, BEAKL, 0, perm_pseudolayer};
void function_197(const struct Chord* self) {
    switch (*self->state) {
        case ACTIVATED:
            key_in(KC_LCTL);
            key_in(KC_LSFT);
...
uint8_t counter_197 = 0;
const struct Chord chord_197 PROGMEM = {H_TOP4, NAV, &state_197, &counter_197, 0, 0, function_197};
...
const struct Chord chord_198 PROGMEM = {H_TOP5, NAV, &state_198, &counter_198, 0, 0, function_198};
uint8_t state_199 = IDLE;
const struct Chord chord_199 PROGMEM = {H_TOP8, NAV, &state_199, NULL, KC_HOME, 0, single_dance};
uint8_t state_200 = IDLE;
const struct Chord chord_200 PROGMEM = {H_TOP9, NAV, &state_200, NULL, KC_UP, 0, single_dance};
uint8_t state_201 = IDLE;
const struct Chord chord_201 PROGMEM = {H_TOP10, NAV, &state_201, NULL, KC_END, 0, single_dance};
uint8_t state_202 = IDLE;
const struct Chord chord_202 PROGMEM = {H_TOP11, NAV, &state_202, NULL, KC_PGUP, 0, single_dance};
uint8_t state_203 = IDLE;
const struct Chord chord_203 PROGMEM = {H_TOP3 + H_BOT3, NAV, &state_203, NULL, KC_LGUI, 0, single_dance};
uint8_t state_204 = IDLE;
const struct Chord chord_204 PROGMEM = {H_TOP4 + H_BOT4, NAV, &state_204, NULL, KC_LCTL, 0, single_dance};
uint8_t state_205 = IDLE;
const struct Chord chord_205 PROGMEM = {H_TOP5 + H_BOT5, NAV, &state_205, NULL, KC_LALT, 0, single_dance};
uint8_t state_206 = IDLE;
const struct Chord chord_206 PROGMEM = {H_TOP6 + H_BOT6, NAV, &state_206, NULL, KC_LSFT, 0, single_dance};
uint8_t state_207 = IDLE;
const struct Chord chord_207 PROGMEM = {H_TOP12 + H_BOT12, NAV, &state_207, NULL, BEAKL, 0, perm_pseudolayer};
void function_208(const struct Chord* self) {
    switch (*self->state) {
        case ACTIVATED:
            key_in(KC_LCTL);
            key_in(KC_Z);
...
uint8_t counter_208 = 0;
const struct Chord chord_208 PROGMEM = {H_BOT2, NAV, &state_208, &counter_208, 0, 0, function_208};
...
const struct Chord chord_209 PROGMEM = {H_BOT3, NAV, &state_209, &counter_209, 0, 0, function_209};
...
const struct Chord chord_210 PROGMEM = {H_BOT4, NAV, &state_210, &counter_210, 0, 0, function_210};
...
const struct Chord chord_211 PROGMEM = {H_BOT5, NAV, &state_211, &counter_211, 0, 0, function_211};
uint8_t state_212 = IDLE;
const struct Chord chord_212 PROGMEM = {H_BOT8, NAV, &state_212, NULL, KC_LEFT, 0, single_dance};
uint8_t state_213 = IDLE;
const struct Chord chord_213 PROGMEM = {H_BOT9, NAV, &state_213, NULL, KC_DOWN, 0, single_dance};
uint8_t state_214 = IDLE;
const struct Chord chord_214 PROGMEM = {H_BOT10, NAV, &state_214, NULL, KC_RIGHT, 0, single_dance};
uint8_t state_215 = IDLE;
const struct Chord chord_215 PROGMEM = {H_BOT11, NAV, &state_215, NULL, KC_PGDN, 0, single_dance};
uint8_t state_216 = IDLE;
const struct Chord chord_216 PROGMEM = {H_THU1, NAV, &state_216, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_217 = IDLE;
const struct Chord chord_217 PROGMEM = {H_TOP5 + H_TOP6, NAV, &state_217, NULL, 8, 0, string_in};
uint8_t state_218 = IDLE;
const struct Chord chord_218 PROGMEM = {H_BOT5 + H_BOT6, NAV, &state_218, NULL, 9, 0, string_in};
uint8_t state_219 = IDLE;
const struct Chord chord_219 PROGMEM = {H_TOP1, MOUSE, &state_219, NULL, 0, 0, reset};
uint8_t state_220 = IDLE;
const struct Chord chord_220 PROGMEM = {H_TOP8, MOUSE, &state_220, NULL, KC_BTN1, 0, single_dance};
uint8_t state_221 = IDLE;
const struct Chord chord_221 PROGMEM = {H_TOP9, MOUSE, &state_221, NULL, KC_MS_U, 0, single_dance};
uint8_t state_222 = IDLE;
const struct Chord chord_222 PROGMEM = {H_TOP10, MOUSE, &state_222, NULL, KC_BTN2, 0, single_dance};
uint8_t state_223 = IDLE;
const struct Chord chord_223 PROGMEM = {H_TOP11, MOUSE, &state_223, NULL, KC_WH_U, 0, single_dance};
uint8_t state_224 = IDLE;
const struct Chord chord_224 PROGMEM = {H_TOP1 + H_BOT1, MOUSE, &state_224, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_225 = IDLE;
const struct Chord chord_225 PROGMEM = {H_TOP3 + H_BOT3, MOUSE, &state_225, NULL, KC_LGUI, 0, single_dance};
uint8_t state_226 = IDLE;
const struct Chord chord_226 PROGMEM = {H_TOP4 + H_BOT4, MOUSE, &state_226, NULL, KC_LCTL, 0, single_dance};
uint8_t state_227 = IDLE;
const struct Chord chord_227 PROGMEM = {H_TOP5 + H_BOT5, MOUSE, &state_227, NULL, KC_LALT, 0, single_dance};
uint8_t state_228 = IDLE;
const struct Chord chord_228 PROGMEM = {H_TOP6 + H_BOT6, MOUSE, &state_228, NULL, KC_LSFT, 0, single_dance};
uint8_t state_229 = IDLE;
const struct Chord chord_229 PROGMEM = {H_BOT8, MOUSE, &state_229, NULL, KC_MS_L, 0, single_dance};
uint8_t state_230 = IDLE;
const struct Chord chord_230 PROGMEM = {H_BOT9, MOUSE, &state_230, NULL, KC_MS_D, 0, single_dance};
uint8_t state_231 = IDLE;
const struct Chord chord_231 PROGMEM = {H_BOT10, MOUSE, &state_231, NULL, KC_MS_R, 0, single_dance};
uint8_t state_232 = IDLE;
const struct Chord chord_232 PROGMEM = {H_BOT11, MOUSE, &state_232, NULL, KC_WH_D, 0, single_dance};
uint8_t state_233 = IDLE;
const struct Chord chord_233 PROGMEM = {H_THU1, MOUSE, &state_233, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_234 = IDLE;
const struct Chord chord_234 PROGMEM = {H_TOP1, STENO, &state_234, NULL, STN_FN, 0, single_dance};
uint8_t state_235 = IDLE;
const struct Chord chord_235 PROGMEM = {H_TOP2, STENO, &state_235, NULL, STN_S1, 0, single_dance};
uint8_t state_236 = IDLE;
const struct Chord chord_236 PROGMEM = {H_TOP3, STENO, &state_236, NULL, STN_TL, 0, single_dance};
uint8_t state_237 = IDLE;
const struct Chord chord_237 PROGMEM = {H_TOP4, STENO, &state_237, NULL, STN_PL, 0, single_dance};
uint8_t state_238 = IDLE;
const struct Chord chord_238 PROGMEM = {H_TOP5, STENO, &state_238, NULL, STN_HL, 0, single_dance};
uint8_t state_239 = IDLE;
const struct Chord chord_239 PROGMEM = {H_TOP6, STENO, &state_239, NULL, STN_ST1, 0, single_dance};
uint8_t state_240 = IDLE;
const struct Chord chord_240 PROGMEM = {H_TOP7, STENO, &state_240, NULL, STN_ST3, 0, single_dance};
uint8_t state_241 = IDLE;
const struct Chord chord_241 PROGMEM = {H_TOP8, STENO, &state_241, NULL, STN_FR, 0, single_dance};
uint8_t state_242 = IDLE;
const struct Chord chord_242 PROGMEM = {H_TOP9, STENO, &state_242, NULL, STN_PR, 0, single_dance};
uint8_t state_243 = IDLE;
const struct Chord chord_243 PROGMEM = {H_TOP10, STENO, &state_243, NULL, STN_LR, 0, single_dance};
uint8_t state_244 = IDLE;
const struct Chord chord_244 PROGMEM = {H_TOP11, STENO, &state_244, NULL, STN_TR, 0, single_dance};
uint8_t state_245 = IDLE;
const struct Chord chord_245 PROGMEM = {H_TOP12, STENO, &state_245, NULL, STN_DR, 0, single_dance};
uint8_t state_246 = IDLE;
const struct Chord chord_246 PROGMEM = {H_BOT1, STENO, &state_246, NULL, STN_PWR, 0, single_dance};
uint8_t state_247 = IDLE;
const struct Chord chord_247 PROGMEM = {H_BOT2, STENO, &state_247, NULL, STN_S2, 0, single_dance};
uint8_t state_248 = IDLE;
const struct Chord chord_248 PROGMEM = {H_BOT3, STENO, &state_248, NULL, STN_KL, 0, single_dance};
uint8_t state_249 = IDLE;
const struct Chord chord_249 PROGMEM = {H_BOT4, STENO, &state_249, NULL, STN_WL, 0, single_dance};
uint8_t state_250 = IDLE;
const struct Chord chord_250 PROGMEM = {H_BOT5, STENO, &state_250, NULL, STN_RL, 0, single_dance};
uint8_t state_251 = IDLE;
const struct Chord chord_251 PROGMEM = {H_BOT6, STENO, &state_251, NULL, STN_ST2, 0, single_dance};
uint8_t state_252 = IDLE;
const struct Chord chord_252 PROGMEM = {H_BOT7, STENO, &state_252, NULL, STN_ST4, 0, single_dance};
uint8_t state_253 = IDLE;
const struct Chord chord_253 PROGMEM = {H_BOT8, STENO, &state_253, NULL, STN_RR, 0, single_dance};
uint8_t state_254 = IDLE;
const struct Chord chord_254 PROGMEM = {H_BOT9, STENO, &state_254, NULL, STN_BR, 0, single_dance};
uint8_t state_255 = IDLE;
const struct Chord chord_255 PROGMEM = {H_BOT10, STENO, &state_255, NULL, STN_GR, 0, single_dance};
uint8_t state_256 = IDLE;
const struct Chord chord_256 PROGMEM = {H_BOT11, STENO, &state_256, NULL, STN_SR, 0, single_dance};
uint8_t state_257 = IDLE;
const struct Chord chord_257 PROGMEM = {H_BOT12, STENO, &state_257, NULL, STN_ZR, 0, single_dance};
uint8_t state_258 = IDLE;
const struct Chord chord_258 PROGMEM = {H_THU1, STENO, &state_258, NULL, STN_N1, 0, single_dance};
uint8_t state_259 = IDLE;
const struct Chord chord_259 PROGMEM = {H_THU2, STENO, &state_259, NULL, STN_A, 0, single_dance};
uint8_t state_260 = IDLE;
const struct Chord chord_260 PROGMEM = {H_THU3, STENO, &state_260, NULL, STN_O, 0, single_dance};
uint8_t state_261 = IDLE;
const struct Chord chord_261 PROGMEM = {H_THU4, STENO, &state_261, NULL, STN_E, 0, single_dance};
uint8_t state_262 = IDLE;
const struct Chord chord_262 PROGMEM = {H_THU5, STENO, &state_262, NULL, STN_U, 0, single_dance};
uint8_t state_263 = IDLE;
const struct Chord chord_263 PROGMEM = {H_THU6, STENO, &state_263, NULL, STN_N7, 0, single_dance};
uint8_t state_264 = IDLE;
const struct Chord chord_264 PROGMEM = {H_TOP1 + H_BOT1, STENO, &state_264, NULL, BEAKL, 0, perm_pseudolayer};
uint8_t state_265 = IDLE;
const struct Chord chord_265 PROGMEM = {H_TOP1, PLOVER, &state_265, NULL, KC_NO, 0, single_dance};
uint8_t state_266 = IDLE;
const struct Chord chord_266 PROGMEM = {H_TOP2, PLOVER, &state_266, NULL, KC_Q, 0, single_dance};
uint8_t state_267 = IDLE;
const struct Chord chord_267 PROGMEM = {H_TOP3, PLOVER, &state_267, NULL, KC_W, 0, single_dance};
uint8_t state_268 = IDLE;
const struct Chord chord_268 PROGMEM = {H_TOP4, PLOVER, &state_268, NULL, KC_E, 0, single_dance};
uint8_t state_269 = IDLE;
const struct Chord chord_269 PROGMEM = {H_TOP5, PLOVER, &state_269, NULL, KC_R, 0, single_dance};
uint8_t state_270 = IDLE;
const struct Chord chord_270 PROGMEM = {H_TOP6, PLOVER, &state_270, NULL, KC_T, 0, single_dance};
uint8_t state_271 = IDLE;
const struct Chord chord_271 PROGMEM = {H_TOP7, PLOVER, &state_271, NULL, KC_Y, 0, single_dance};
uint8_t state_272 = IDLE;
const struct Chord chord_272 PROGMEM = {H_TOP8, PLOVER, &state_272, NULL, KC_U, 0, single_dance};
uint8_t state_273 = IDLE;
const struct Chord chord_273 PROGMEM = {H_TOP9, PLOVER, &state_273, NULL, KC_I, 0, single_dance};
uint8_t state_274 = IDLE;
const struct Chord chord_274 PROGMEM = {H_TOP10, PLOVER, &state_274, NULL, KC_O, 0, single_dance};
uint8_t state_275 = IDLE;
const struct Chord chord_275 PROGMEM = {H_TOP11, PLOVER, &state_275, NULL, KC_P, 0, single_dance};
uint8_t state_276 = IDLE;
const struct Chord chord_276 PROGMEM = {H_TOP12, PLOVER, &state_276, NULL, KC_LBRACKET, 0, single_dance};
uint8_t state_277 = IDLE;
const struct Chord chord_277 PROGMEM = {H_BOT1, PLOVER, &state_277, NULL, KC_NO, 0, single_dance};
uint8_t state_278 = IDLE;
const struct Chord chord_278 PROGMEM = {H_BOT2, PLOVER, &state_278, NULL, KC_A, 0, single_dance};
uint8_t state_279 = IDLE;
const struct Chord chord_279 PROGMEM = {H_BOT3, PLOVER, &state_279, NULL, KC_S, 0, single_dance};
uint8_t state_280 = IDLE;
const struct Chord chord_280 PROGMEM = {H_BOT4, PLOVER, &state_280, NULL, KC_D, 0, single_dance};
uint8_t state_281 = IDLE;
const struct Chord chord_281 PROGMEM = {H_BOT5, PLOVER, &state_281, NULL, KC_F, 0, single_dance};
uint8_t state_282 = IDLE;
const struct Chord chord_282 PROGMEM = {H_BOT6, PLOVER, &state_282, NULL, KC_G, 0, single_dance};
uint8_t state_283 = IDLE;
const struct Chord chord_283 PROGMEM = {H_BOT7, PLOVER, &state_283, NULL, KC_H, 0, single_dance};
uint8_t state_284 = IDLE;
const struct Chord chord_284 PROGMEM = {H_BOT8, PLOVER, &state_284, NULL, KC_J, 0, single_dance};
uint8_t state_285 = IDLE;
const struct Chord chord_285 PROGMEM = {H_BOT9, PLOVER, &state_285, NULL, KC_K, 0, single_dance};
uint8_t state_286 = IDLE;
const struct Chord chord_286 PROGMEM = {H_BOT10, PLOVER, &state_286, NULL, KC_L, 0, single_dance};
uint8_t state_287 = IDLE;
const struct Chord chord_287 PROGMEM = {H_BOT11, PLOVER, &state_287, NULL, KC_SCOLON, 0, single_dance};
uint8_t state_288 = IDLE;
const struct Chord chord_288 PROGMEM = {H_BOT12, PLOVER, &state_288, NULL, KC_QUOTE, 0, single_dance};
uint8_t state_289 = IDLE;
const struct Chord chord_289 PROGMEM = {H_THU1, PLOVER, &state_289, NULL, KC_1, 0, single_dance};
uint8_t state_290 = IDLE;
const struct Chord chord_290 PROGMEM = {H_THU2, PLOVER, &state_290, NULL, KC_C, 0, single_dance};
uint8_t state_291 = IDLE;
const struct Chord chord_291 PROGMEM = {H_THU3, PLOVER, &state_291, NULL, KC_V, 0, single_dance};
uint8_t state_292 = IDLE;
const struct Chord chord_292 PROGMEM = {H_THU4, PLOVER, &state_292, NULL, KC_N, 0, single_dance};
uint8_t state_293 = IDLE;
const struct Chord chord_293 PROGMEM = {H_THU5, PLOVER, &state_293, NULL, KC_M, 0, single_dance};
uint8_t state_294 = IDLE;
const struct Chord chord_294 PROGMEM = {H_THU6, PLOVER, &state_294, NULL, KC_1, 0, single_dance};
uint8_t state_295 = IDLE;
const struct Chord chord_295 PROGMEM = {H_TOP1 + H_BOT1, PLOVER, &state_295, NULL, BEAKL, 0, perm_pseudolayer};
