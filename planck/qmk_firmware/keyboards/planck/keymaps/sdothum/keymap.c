...
// http://www.keyboard-layout-editor.com/#/gists/7af107f03a4a1f06f5a4af35994e3d77
  ...
  [_LSHIFT] = {
    {S(KC_Q), TD_LBRC, KC_EQL,  TD_RBRC, S(KC_X), OS_CALT, OS_CGUI, S(KC_G), S(KC_C), S(KC_R), S(KC_F), S(KC_Z)},
    {S(KC_K), TD_LT,   KC_EXLM, TD_GT,   TD_TILD, OS_SALT, OS_SGUI, S(KC_D), S(KC_S), S(KC_T), S(KC_N), S(KC_B)},
    {S(KC_J), TD_COLN, TD_DQOT, S(KC_I), TD_GRV,  TD_CAPS, OS_CSFT, S(KC_W), S(KC_M), S(KC_L), S(KC_P), S(KC_V)},
    {OS_CTL,  OS_GUI,  OS_ALT,  LT_ESC,  ___fn__, LT_TAB,  KC_DEL,  KC_UNDS, PS_LEFT, S_DOWN,  S_UP,    S_RGHT },
  },
  ...
  [_RSHIFT] = {
    {S(KC_Q), S(KC_Y), S(KC_O), S(KC_U), S(KC_X), OS_CALT, OS_CGUI, S(KC_G), TD_LCBR, KC_PLUS, TD_RCBR, S(KC_Z)},
    {S(KC_K), S(KC_H), S(KC_E), S(KC_A), KC_QUES, OS_SALT, OS_SGUI, S(KC_D), TD_LPRN, KC_ASTR, TD_RPRN, S(KC_B)},
    {S(KC_J), TD_COLN, TD_DQOT, S(KC_I), KC_SLSH, TD_CAPS, OS_CSFT, S(KC_W), S(KC_M), S(KC_L), S(KC_P), S(KC_V)},
    {OS_CTL,  OS_GUI,  OS_ALT,  KC_CAPS, KC_MINS, PS_TAB,  LT_BSPC, ___fn__, PS_LEFT, S_DOWN,  S_UP,    S_RGHT },
  },
#endif
...
// .................................................................... BEAKL 10
#ifdef BEAKL10
// http://www.keyboard-layout-editor.com/#/gists/26c6a1508eb6d21a306a214cffb69f95
...
// http://www.keyboard-layout-editor.com/#/gists/8998a52a4268b19abf119e60bbce0c98
  ...
  [_LSHIFT] = {
    {S(KC_Q), TD_LBRC, KC_EQL,  TD_RBRC, S(KC_X), OS_CALT, OS_CGUI, S(KC_G), S(KC_D), S(KC_N), S(KC_M), S(KC_V)},
    {S(KC_Y), TD_LT,   KC_EXLM, TD_GT,   TD_TILD, OS_SALT, OS_SGUI, S(KC_C), S(KC_S), S(KC_R), S(KC_T), S(KC_W)},
