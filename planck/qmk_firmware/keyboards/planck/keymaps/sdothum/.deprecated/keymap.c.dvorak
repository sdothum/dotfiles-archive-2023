...
// http://www.keyboard-layout-editor.com/#/gists/34a2cb32e4f9267275c08a8089ca2d3c
  ...
  // ,-----------------------------------------------------------------------------------.
  // |   Q  |   W  |   F  |   P  |   V  | ^Alt | ^GUI |   J  |   L  |   U  |   Y  |   ;  |
  // |------+------+------+------+------+-------------+------+------+------+------+------|
  // |   A  |   R  |   S  |   T  |   G  | Caps |^Shift|   M  |   N  |   E  |   I  |   O  |
  // |------+------+------+------+------+------|------+------+------+------+------+------|
  ...
  [_COLEMAK] = {
    {KC_Q,    KC_W,    KC_F,    KC_P,    KC_V,    OS_CALT, OS_CGUI,  KC_J,    KC_L,    KC_U,    KC_Y,   KC_SCLN},
    {KC_A,    KC_R,    KC_S,    KC_T,    KC_G,    TD_CAPS, OS_CSFT,  KC_M,    KC_N,    KC_E,    KC_I,   KC_O   },
...
// ...................................................................... Dvorak
//
// http://www.keyboard-layout-editor.com/#/gists/8337b0d543cd8031e03286b70f1a11d2

  // ,-----------------------------------------------------------------------------------.
  // |   "  |   ,  |   .  |   Y  |   G  | ^Alt | ^GUI |   F  |   L  |   C  |   R  |   P  |
  // |------+------+------+------+------+-------------+------+------+------+------+------|
  // |   A  |   O  |   E  |   I  |   U  | Caps |^Shift|   D  |   H  |   T  |   N  |   S  |
  // |------+------+------+------+------+------|------+------+------+------+------+------|
  // |   ;  |   Q  |   J  |   K  |   X  | ↑Alt | ↑GUI |   B  |   M  |   W  |   V  |   Z  |
  // |------+------+------+------+------+------+------+------+------+------+------+------|
  // | Ctrl |  GUI |  Alt |  Esc | Space|  Tab | Bksp |  Ent | Left | Down |  Up  |Right |
  // `-----------------------------------------------------------------------------------'

  [_DVORAK] = {
    {TD_QUOT, KC_COMM, KC_DOT,  KC_Y,    KC_G,    OS_CALT, OS_CGUI,  KC_F,    KC_L,    KC_C,    KC_R,   KC_P,  },
    {KC_A,    KC_O,    KC_E,    KC_I,    KC_U,    TD_CAPS, OS_CSFT,  KC_D,    KC_H,    KC_T,    KC_N,   KC_S,  },
    {KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,    OS_SALT, OS_SGUI,  KC_B,    KC_M,    KC_W,    KC_V,   KC_Z,  },
    {OS_CTL,  OS_GUI,  OS_ALT,  LT_ESC,  TD_SPC,  LT_TAB,  LT_BSPC,  TD_ENT,  LT_LEFT, AT_DOWN, GT_UP,  CT_RGHT},
  },
...
// http://www.keyboard-layout-editor.com/#/gists/3e7b27b824d0c8b71f07354170756803
  ...
  [_LCOLEMAK] = {
    {S(KC_Q), S(KC_W), S(KC_F), S(KC_P), S(KC_V), OS_CALT, OS_CGUI, S(KC_J), S(KC_L), S(KC_U), S(KC_Y), KC_COLN},
    {S(KC_A), S(KC_R), S(KC_S), S(KC_T), S(KC_G), TD_CAPS, OS_CSFT, S(KC_M), S(KC_N), S(KC_E), S(KC_I), S(KC_O)},
    {S(KC_Z), S(KC_X), S(KC_C), S(KC_D), S(KC_B), OS_SALT, OS_SGUI, S(KC_K), S(KC_H), KC_SLSH, KC_QUES, TD_DQOT},
  ...
  [_RCOLEMAK] = {
    {S(KC_Q), S(KC_W), S(KC_F), S(KC_P), S(KC_V), OS_CALT, OS_CGUI, S(KC_J), S(KC_L), S(KC_U), S(KC_Y), KC_COLN},
    {S(KC_A), S(KC_R), S(KC_S), S(KC_T), S(KC_G), TD_CAPS, OS_CSFT, S(KC_M), S(KC_N), S(KC_E), S(KC_I), S(KC_O)},
    {S(KC_Z), S(KC_X), S(KC_C), S(KC_D), S(KC_B), OS_SALT, OS_SGUI, S(KC_K), S(KC_H), KC_TILD, TD_GRV,  TD_DQOT},
...
// ................................................................ Shift Dvorak
  ...
  [_LDVORAK] = {
    {TD_QUOT, KC_TILD, TD_GRV,  S(KC_Y), S(KC_G), OS_CALT, OS_CGUI, S(KC_F), S(KC_L), S(KC_C), S(KC_R), S( KC_P)},
    {S(KC_A), S(KC_O), S(KC_E), S(KC_I), S(KC_U), TD_CAPS, OS_CSFT, S(KC_D), S(KC_H), S(KC_T), S(KC_N), S( KC_S)},
    {KC_SCLN, S(KC_Q), S(KC_J), S(KC_K), S(KC_X), OS_SALT, OS_SGUI, S(KC_B), S(KC_M), S(KC_W), S(KC_V), S( KC_Z)},
    {OS_CTL,  OS_GUI,  OS_ALT,  LT_ESC,  TD_SPC,  LT_TAB,  LT_BSPC, TD_ENT,  LT_LEFT, AT_DOWN, GT_UP,    CT_RGHT},
  },
  ...
  [_RDVORAK] = {
    {TD_QUOT, KC_SLSH, KC_QUES, S(KC_Y), S(KC_G), OS_CALT, OS_CGUI, S(KC_F), S(KC_L), S(KC_C), S(KC_R), S( KC_P)},
    {S(KC_A), S(KC_O), S(KC_E), S(KC_I), S(KC_U), TD_CAPS, OS_CSFT, S(KC_D), S(KC_H), S(KC_T), S(KC_N), S( KC_S)},
    {KC_SCLN, S(KC_Q), S(KC_J), S(KC_K), S(KC_X), OS_SALT, OS_SGUI, S(KC_B), S(KC_M), S(KC_W), S(KC_V), S( KC_Z)},
    {OS_CTL,  OS_GUI,  OS_ALT,  LT_ESC,  TD_SPC,  LT_TAB,  LT_BSPC, TD_ENT,  LT_LEFT, AT_DOWN, GT_UP,    CT_RGHT},
  },
...
// http://www.keyboard-layout-editor.com/#/gists/ac56b98d8737118f2beef3d6855d760e
  ...
  [_ADJUST] = {
    ...
    {_______, _______, COLEMAK, DVORAK,  _______, _______, _______, _______, _______, TD_LT,   KC_GT,   _______},
...
void dvorak(keyrecord_t *record)
{
  if (record->event.pressed) {
#ifdef AUDIO_ENABLE
