...
// ....................................................................... Regex
  ...
  // |      |   :  |   !  |   =  |   `  |  Num | Regex|   \  |   *  |   .  |   @  |      |
  // |------+------+------+------+------+------+------+------+------+------+------+------|
  // | Ctrl |  GUI |  Alt |  f() |   -  | Space| BkSp |   +  | Left | Down |  Up  | Right|
  // `-----------------------------------------------------------------------------------'

  [_TTREGEX] = {
    {___x___, KC_QUES, KC_LCBR, KC_RCBR, KC_AMPR, ___x___, ___x___, KC_PERC, KC_LBRC, KC_RBRC, KC_CIRC, ___x___},
    {___x___, KC_SLSH, KC_LT,   KC_GT,   KC_TILD, ___x___, ___x___, KC_PIPE, KC_LPRN, KC_RPRN, KC_DLR,  ___x___},
    {___x___, KC_COLN, KC_EXLM, KC_EQL,  KC_GRV,  ___x___, ___x___, KC_BSLS, KC_ASTR, KC_DOT,  KC_AT,   ___x___},
    {OS_CTL,  OS_GUI,  OS_ALT,  TT_ESC,  KC_MINS, KC_SPC,  KC_BSPC, KC_PLUS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT},
  },
