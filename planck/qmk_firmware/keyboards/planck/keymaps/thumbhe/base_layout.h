...
// .................................................................. BEAKL HIEA
  ...
  // |------+------+------+------+------+------+------+------+------+------+------+------|
  // | Ctrl |  GUI |  Alt |  Esc |   H  |  Ins | Left | Space| Enter| Down |  Up  | Right|
  // `-----------------------------------------------------------------------------------'
  ...
  [_BASE] = {
    ...
    {OS_CTL,  OS_GUI,  OS_ALT,  LT_ESC,  LT_H,    LT_INS,  LT_LEFT, TD_SPC,  TD_ENT,  AT_DOWN, GT_UP,   CT_RGHT},
  },
  ...
  [_SHIFT] = {
    ...
    {OS_CTL,  OS_GUI,  OS_ALT,  KC_ESC,  S(KC_H), LT_INS,  LT_LEFT, KC_SPC,  KC_ENT,  AT_DOWN, GT_UP,   CT_RGHT},
  },
  ...
  [_LSHIFT] = {
    ...
    {OS_CTL,  OS_GUI,  OS_ALT,  KC_TAB,  ___fn__, LT_INS,  S_LEFT,  KC_BSPC, SL_DEL,  S_DOWN,  S_UP,    S_RGHT },
  },
  ...
  [_LSYMBOL] = {
    ...
    {_______, _______, _______, ___fn__, ___x___, _______, _______, KC_BSLS, SP_DEL,  _______, _______, _______},
  },
