...
// .............................................................. CapsLock Layer
  ...
  [_TTCAPS] = KEYMAP( 
  // ---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------
      TD_COLN , S(KC_Y) , S(KC_O) , S(KC_U) , KC_MINS ,  __x__  ,  __x__  , S(KC_G) , S(KC_D) , S(KC_N) , S(KC_M) , S(KC_Z) ,
  // ---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------
...
// ....................................................................... Regex
  ...
  [_TTREGEX] = KEYMAP( 
  // ---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------
        ___   , KC_DOT  , KC_ASTR , KC_AMPR , KC_PLUS ,  __x__  ,  __x__  , KC_ASTR , KC_LBRC , KC_CIRC , KC_RBRC ,   ___   ,
  // ---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------
        ___   , KC_QUES , KC_EXLM , KC_SLSH , KC_PIPE ,  __x__  ,  __x__  , KC_QUES , KC_LPRN , KC_DLR  , KC_RPRN ,   ___   ,
  // ---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------
        ___   , KC_LT   , KC_GT   , KC_PERC , KC_AT   ,  __x__  ,  __x__  , KC_PIPE , KC_LCBR , KC_HASH , KC_RCBR ,   ___   ,
  // ---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------
