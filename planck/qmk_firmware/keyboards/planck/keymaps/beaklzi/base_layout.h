...
// .................................................................... BEAKL SI
  ...
  // ---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------
      S(KC_Q) , S(KC_H) , S(KC_E) , S(KC_A) , KC_QUES ,  __x__  ,  __x__  , S(KC_C) , S(KC_T) , S(KC_R) , S(KC_S) , S(KC_W) ,
  // ---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------
      S(KC_J) , KC_UNDS , KC_DQT  , S(KC_K) , KC_EXLM ,  __x__  ,  __x__  , S(KC_B) , S(KC_P) , S(KC_L) , S(KC_F) , S(KC_V) ,
  // ---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------
