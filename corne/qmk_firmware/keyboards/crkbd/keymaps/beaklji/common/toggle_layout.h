...
// .............................................................. CapsLock Layer
  ...
  [_TTCAPS] = KEYMAP(
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
      ___x___ , S(KC_Q) , S(KC_Y) , S(KC_O) , S(KC_U) , TD_COLN ,                      S(KC_G) , S(KC_D) , S(KC_N) , S(KC_M) , S(KC_X) , ___x___ ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
#ifdef UPPER_HEX
      ___x___ , S(KC_J) , S(KC_H) , S(KC_E) , ST_A    , KC_DOT  ,                      S(KC_C) , ST_T    , S(KC_R) , S(KC_S) , S(KC_W) , ___x___ ,
#else
      ___x___ , S(KC_J) , S(KC_H) , S(KC_E) , S(KC_A) , KC_DOT  ,                      S(KC_C) , ST_T    , S(KC_R) , S(KC_S) , S(KC_W) , ___x___ ,
#endif
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
      ___x___ , S(KC_Z) , KC_MINS , KC_QUOT , S(KC_K) , KC_COMM ,                      S(KC_B) , S(KC_P) , S(KC_L) , S(KC_F) , S(KC_V) , ___x___ ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
