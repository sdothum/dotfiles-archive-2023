...
// .............................................................. CapsLock Layer
  ...
  [_TTCAPS] = KEYMAP(
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
       __x__  , S(KC_Z) , S(KC_Y) , S(KC_O) , S(KC_U) , TD_COLN ,                      S(KC_G) , S(KC_D) , S(KC_N) , S(KC_M) , S(KC_X) ,  __x__  ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
  ...
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
                                               __x__  , KC_I    , KC_TAB  ,  KC_ENT  , KC_SPC  , KC_BSPC 
  //                                         ---------+---------+---------  ---------+---------+--------- 
  ),
  ...
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
       __x__  , KC_Z    , KC_Y    , KC_O    , KC_U    , KC_COLN ,                      KC_G    , KC_D    , KC_N    , KC_M    , KC_X    ,  __x__  ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
       __x__  , KC_Q    , KC_H    , KC_E    , KC_A    , KC_DOT  ,                      KC_C    ,  __x__  , KC_R    , KC_S    , KC_W    ,  __x__  ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
       __x__  , KC_J    , KC_MINS , KC_QUOT , KC_K    , KC_COMM ,                      KC_B    , KC_P    , KC_L    , KC_F    , KC_V    ,  __x__  ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
                                               __x__  , KC_I    , KC_TAB  ,  KC_ENT  , KC_SPC  , KC_BSPC 
