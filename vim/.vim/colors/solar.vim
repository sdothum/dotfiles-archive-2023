...
" Website:      https://github.com/lifepillar/vim-solar
...
if !get(g:, 'solarized_use16', 0)
  if &background ==# 'dark'
    ...
    "   base3: GUI=#eee8d5/rgb(253,246,227)  Term=230 #ffffd7/rgb(255,255,215)  [delta=7.816259]
    "  orange: GUI=#cb4b16/rgb(203, 75, 22)  Term=166 #d75f00/rgb(215, 95,  0)  [delta=8.065025]
    "   base2: GUI=#fdf6e3/rgb(238,232,213)  Term=254 #e4e4e4/rgb(228,228,228)  [delta=8.289679]
    ...
    let g:terminal_ansi_colors = ['#073642', '#dc322f', '#859900', '#b58900', '#268bd2', '#d33682', '#2aa198', '#fdf6e3',
          \ '#002b36', '#cb4b16', '#586e75', '#657b83', '#839496', '#6c71c4', '#93a1a1', '#eee8d5']
    ...
    if get(g:, "solarized_visibility", "") == "high"
      ...
      hi SpellBad ctermfg=61 ctermbg=230 guifg=#6c71c4 guibg=#eee8d5 guisp=#dc322f cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
      hi SpellCap ctermfg=61 ctermbg=230 guifg=#6c71c4 guibg=#eee8d5 guisp=#dc322f cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
      hi SpellLocal ctermfg=136 ctermbg=230 guifg=#b58900 guibg=#eee8d5 guisp=#dc322f cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
      hi SpellRare ctermfg=37 ctermbg=230 guifg=#2aa198 guibg=#eee8d5 guisp=#dc322f cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
    ...
    if get(g:, 'solarized_old_cursor_style', 0)
      ...
      hi Cursor ctermfg=230 ctermbg=32 guifg=#eee8d5 guibg=#268bd2 guisp=NONE cterm=NONE gui=NONE
    endif
    ...
    hi ErrorMsg ctermfg=160 ctermbg=230 guifg=#dc322f guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi IncSearch ctermfg=166 ctermbg=NONE guifg=#cb4b16 guibg=NONE guisp=NONE cterm=NONE,standout gui=NONE,standout
    hi MatchParen ctermfg=230 ctermbg=236 guifg=#eee8d5 guibg=#073642 guisp=NONE cterm=NONE,bold gui=NONE,bold
    ...
    hi PmenuSbar ctermfg=254 ctermbg=246 guifg=#fdf6e3 guibg=#839496 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi PmenuSel ctermfg=242 ctermbg=254 guifg=#586e75 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    ...
    if get(g:, "solarized_statusline", "") == "low"
      hi StatusLine ctermfg=242 ctermbg=254 guifg=#586e75 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
      ...
      hi TabLineSel ctermfg=246 ctermbg=230 guifg=#839496 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    else
    ...
    hi WildMenu ctermfg=254 ctermbg=236 guifg=#fdf6e3 guibg=#073642 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    ...
    hi NormalMode ctermfg=246 ctermbg=230 guifg=#839496 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi InsertMode ctermfg=37 ctermbg=230 guifg=#2aa198 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi ReplaceMode ctermfg=166 ctermbg=230 guifg=#cb4b16 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi VisualMode ctermfg=162 ctermbg=230 guifg=#d33682 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi CommandMode ctermfg=162 ctermbg=230 guifg=#d33682 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  "    back: GUI=#eee8d5/rgb(253,246,227)  Term=230 #ffffd7/rgb(255,255,215)  [delta=7.816259]
  "  base03: GUI=#eee8d5/rgb(253,246,227)  Term=230 #ffffd7/rgb(255,255,215)  [delta=7.816259]
  "  orange: GUI=#cb4b16/rgb(203, 75, 22)  Term=166 #d75f00/rgb(215, 95,  0)  [delta=8.065025]
  "  base02: GUI=#fdf6e3/rgb(238,232,213)  Term=254 #e4e4e4/rgb(228,228,228)  [delta=8.289679]
  ...
  let g:terminal_ansi_colors = ['#fdf6e3', '#dc322f', '#859900', '#b58900', '#268bd2', '#d33682', '#2aa198', '#073642',
  ...
  if !has('gui_running') && get(g:, 'solarized_termtrans', 0)
    ...
    hi Folded ctermfg=66 ctermbg=NONE guifg=#657b83 guibg=NONE guisp=#eee8d5 cterm=NONE,bold gui=NONE,bold
    hi LineNr ctermfg=247 ctermbg=NONE guifg=#93a1a1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi Terminal ctermfg=fg ctermbg=NONE guifg=fg guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi CursorLineNr ctermbg=NONE guifg=NONE
  else
    hi Normal ctermfg=66 ctermbg=230 guifg=#657b83 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
    hi FoldColumn ctermfg=66 ctermbg=254 guifg=#657b83 guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
    hi Folded ctermfg=66 ctermbg=254 guifg=#657b83 guibg=#fdf6e3 guisp=#eee8d5 cterm=NONE,bold gui=NONE,bold
    hi LineNr ctermfg=247 ctermbg=254 guifg=#93a1a1 guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
    hi Terminal ctermfg=fg ctermbg=230 guifg=fg guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
    hi CursorLineNr ctermbg=254 guibg=#fdf6e3
  endif
  if get(g:, "solarized_visibility", "") == "high"
    hi CursorLineNr ctermfg=160 guifg=#dc322f cterm=bold gui=bold
    if get(g:, 'solarized_old_cursor_style', 0)
      hi Cursor ctermfg=230 ctermbg=66 guifg=#eee8d5 guibg=#657b83 guisp=NONE cterm=NONE gui=NONE
    else
      hi Cursor ctermfg=230 ctermbg=160 guifg=#eee8d5 guibg=#dc322f guisp=NONE cterm=NONE gui=NONE
    endif
    hi MatchParen ctermfg=230 ctermbg=246 guifg=#eee8d5 guibg=#839496 guisp=NONE cterm=NONE,bold gui=NONE,bold
    ...
    hi SpellBad ctermfg=162 ctermbg=230 guifg=#d33682 guibg=#eee8d5 guisp=#6c71c4 cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
    hi SpellCap ctermfg=162 ctermbg=230 guifg=#d33682 guibg=#eee8d5 guisp=#6c71c4 cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
    hi SpellLocal ctermfg=136 ctermbg=230 guifg=#b58900 guibg=#eee8d5 guisp=#cb4b16 cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
    hi SpellRare ctermfg=37 ctermbg=230 guifg=#2aa198 guibg=#eee8d5 guisp=#cb4b16 cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
  ...
  elseif get(g:, "solarized_visibility", "") == "low"
    ...
    if get(g:, 'solarized_old_cursor_style', 0)
      ...
      hi Cursor ctermfg=230 ctermbg=166 guifg=#eee8d5 guibg=#cb4b16 guisp=NONE cterm=NONE gui=NONE
    endif
    hi MatchParen ctermfg=160 ctermbg=254 guifg=#dc322f guibg=#fdf6e3 guisp=NONE cterm=NONE,bold,underline gui=NONE,bold,underline
    hi NonText ctermfg=254 ctermbg=NONE guifg=#fdf6e3 guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
    hi SpecialKey ctermfg=254 ctermbg=NONE guifg=#fdf6e3 guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
    ...
    hi SpecialKey ctermfg=246 ctermbg=254 guifg=#839496 guibg=#fdf6e3 guisp=NONE cterm=NONE,bold gui=NONE,bold
    hi SpellBad ctermfg=162 ctermbg=NONE guifg=#d33682 guibg=NONE guisp=#6c71c4 cterm=NONE,underline gui=NONE,undercurl
    hi SpellCap ctermfg=162 ctermbg=NONE guifg=#d33682 guibg=NONE guisp=#6c71c4 cterm=NONE,underline gui=NONE,undercurl
    hi SpellLocal ctermfg=136 ctermbg=NONE guifg=#b58900 guibg=NONE guisp=#b58900 cterm=NONE,underline gui=NONE,undercurl
    hi SpellRare ctermfg=37 ctermbg=NONE guifg=#2aa198 guibg=NONE guisp=#2aa198 cterm=NONE,underline gui=NONE,undercurl
  ...
  hi ColorColumn ctermfg=NONE ctermbg=254 guifg=NONE guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
  hi Conceal ctermfg=32 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi CursorColumn ctermfg=NONE ctermbg=254 guifg=NONE guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
  hi CursorLine ctermfg=NONE ctermbg=254 guifg=NONE guibg=#fdf6e3 guisp=#586e75 cterm=NONE gui=NONE
  if get(g:, "solarized_diffmode", "") == "high"
    hi DiffAdd ctermfg=106 ctermbg=NONE guifg=#859900 guibg=NONE guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi DiffChange ctermfg=136 ctermbg=NONE guifg=#b58900 guibg=NONE guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi DiffDelete ctermfg=160 ctermbg=NONE guifg=#dc322f guibg=NONE guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  elseif get(g:, "solarized_diffmode", "") == "low"
    ...
    hi DiffAdd ctermfg=106 ctermbg=254 guifg=#859900 guibg=#fdf6e3 guisp=#859900 cterm=NONE gui=NONE
    hi DiffChange ctermfg=136 ctermbg=254 guifg=#b58900 guibg=#fdf6e3 guisp=#b58900 cterm=NONE gui=NONE
    hi DiffDelete ctermfg=160 ctermbg=254 guifg=#dc322f guibg=#fdf6e3 guisp=NONE cterm=NONE,bold gui=NONE,bold
    hi DiffText ctermfg=32 ctermbg=254 guifg=#268bd2 guibg=#fdf6e3 guisp=#268bd2 cterm=NONE gui=NONE
  endif
  hi Directory ctermfg=32 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi EndOfBuffer ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi ErrorMsg ctermfg=160 ctermbg=230 guifg=#dc322f guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  hi ModeMsg ctermfg=32 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi MoreMsg ctermfg=32 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi Pmenu ctermfg=66 ctermbg=254 guifg=#657b83 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  hi PmenuThumb ctermfg=66 ctermbg=230 guifg=#657b83 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi Question ctermfg=37 ctermbg=NONE guifg=#2aa198 guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi! link QuickFixLine Search
  hi Search ctermfg=136 ctermbg=NONE guifg=#b58900 guibg=NONE guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi SignColumn ctermfg=66 ctermbg=NONE guifg=#657b83 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  if get(g:, "solarized_statusline", "") == "low"
    hi StatusLine ctermfg=247 ctermbg=230 guifg=#93a1a1 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    ...
    hi TabLineSel ctermfg=242 ctermbg=230 guifg=#586e75 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  else
    hi StatusLine ctermfg=242 ctermbg=254 guifg=#586e75 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi StatusLineNC ctermfg=246 ctermbg=254 guifg=#839496 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi TabLine ctermfg=246 ctermbg=254 guifg=#839496 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi TabLineFill ctermfg=246 ctermbg=254 guifg=#839496 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    hi TabLineSel ctermfg=242 ctermbg=254 guifg=#586e75 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  endif
  hi! link StatusLineTerm StatusLine
  hi! link StatusLineTermNC StatusLineNC
  hi VertSplit ctermfg=242 ctermbg=247 guifg=#586e75 guibg=#93a1a1 guisp=NONE cterm=NONE gui=NONE
  hi Visual ctermfg=247 ctermbg=230 guifg=#93a1a1 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi VisualNOS ctermfg=NONE ctermbg=254 guifg=NONE guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi WarningMsg ctermfg=166 ctermbg=NONE guifg=#cb4b16 guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi WildMenu ctermfg=236 ctermbg=254 guifg=#073642 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi! link Boolean Constant
  hi! link Character Constant
  ...
  hi! link lCursor Cursor
  hi CursorIM ctermfg=NONE ctermbg=fg guifg=NONE guibg=fg guisp=NONE cterm=NONE gui=NONE
  hi ToolbarLine ctermfg=NONE ctermbg=254 guifg=NONE guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
  hi ToolbarButton ctermfg=242 ctermbg=254 guifg=#586e75 guibg=#fdf6e3 guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi NormalMode ctermfg=242 ctermbg=230 guifg=#586e75 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi InsertMode ctermfg=37 ctermbg=230 guifg=#2aa198 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi ReplaceMode ctermfg=166 ctermbg=230 guifg=#cb4b16 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi VisualMode ctermfg=162 ctermbg=230 guifg=#d33682 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi CommandMode ctermfg=162 ctermbg=230 guifg=#d33682 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  if get(g:, 'solarized_extra_hi_groups', 0)
    ...
    hi javaScript ctermfg=136 ctermbg=NONE guifg=#b58900 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link jsFuncCall Function
    hi perlHereDoc ctermfg=242 ctermbg=230 guifg=#586e75 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
    hi perlVarPlain ctermfg=136 ctermbg=230 guifg=#b58900 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
    hi perlStatementFileDesc ctermfg=37 ctermbg=230 guifg=#2aa198 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
    hi texstatement ctermfg=37 ctermbg=230 guifg=#2aa198 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
    hi texmathzonex ctermfg=136 ctermbg=230 guifg=#b58900 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
    hi texmathmatcher ctermfg=136 ctermbg=230 guifg=#b58900 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
    hi texreflabel ctermfg=136 ctermbg=230 guifg=#b58900 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
    hi rubyDefine ctermfg=242 ctermbg=230 guifg=#586e75 guibg=#eee8d5 guisp=NONE cterm=NONE,bold gui=NONE,bold
    hi! link rubySymbol Type
    hi rubyBoolean ctermfg=162 ctermbg=230 guifg=#d33682 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
    let hs_highlight_boolean=1
    let hs_highlight_delimiters=1
    hi cPreCondit ctermfg=166 ctermbg=NONE guifg=#cb4b16 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi VarId ctermfg=32 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi! link pandocTableStructureTop pandocTableStructre
    hi! link pandocTableStructureEnd pandocTableStructre
    hi pandocTableZebraLight ctermfg=32 ctermbg=230 guifg=#268bd2 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
    hi pandocTableZebraDark ctermfg=32 ctermbg=254 guifg=#268bd2 guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
    hi pandocEmphasisTable ctermfg=32 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE,italic
    hi pandocEmphasisNestedTable ctermfg=32 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
    hi pandocStrongEmphasisTable ctermfg=32 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
    hi pandocStrongEmphasisNestedTable ctermfg=32 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
  ...
  if has('nvim')
    hi! link TermCursor Cursor
    hi TermCursorNC ctermfg=230 ctermbg=247 guifg=#eee8d5 guibg=#93a1a1 guisp=NONE cterm=NONE gui=NONE
...
if &background ==# 'dark'
  ...
  if get(g:, "solarized_visibility", "") == "high"
    ...
    hi SpellBad ctermfg=13 ctermbg=15 guifg=#6c71c4 guibg=#eee8d5 guisp=#dc322f cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
    hi SpellCap ctermfg=13 ctermbg=15 guifg=#6c71c4 guibg=#eee8d5 guisp=#dc322f cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
    hi SpellLocal ctermfg=3 ctermbg=15 guifg=#b58900 guibg=#eee8d5 guisp=#dc322f cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
    hi SpellRare ctermfg=6 ctermbg=15 guifg=#2aa198 guibg=#eee8d5 guisp=#dc322f cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
  ...
  if get(g:, 'solarized_old_cursor_style', 0)
    ...
    hi Cursor ctermfg=15 ctermbg=4 guifg=#eee8d5 guibg=#268bd2 guisp=NONE cterm=NONE gui=NONE
  endif
  ...
  hi EndOfBuffer ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi ErrorMsg ctermfg=1 ctermbg=15 guifg=#dc322f guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi IncSearch ctermfg=9 ctermbg=NONE guifg=#cb4b16 guibg=NONE guisp=NONE cterm=NONE,standout gui=NONE,standout
  hi MatchParen ctermfg=15 ctermbg=0 guifg=#eee8d5 guibg=#073642 guisp=NONE cterm=NONE,bold gui=NONE,bold
  ...
  hi PmenuSbar ctermfg=7 ctermbg=12 guifg=#fdf6e3 guibg=#839496 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi PmenuSel ctermfg=10 ctermbg=7 guifg=#586e75 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  if get(g:, "solarized_statusline", "") == "low"
    hi StatusLine ctermfg=10 ctermbg=7 guifg=#586e75 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
    ...
    hi TabLineSel ctermfg=12 ctermbg=15 guifg=#839496 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  else
  ...
  hi WildMenu ctermfg=7 ctermbg=0 guifg=#fdf6e3 guibg=#073642 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi! link Boolean Constant
  hi! link Character Constant
  ...
  hi NormalMode ctermfg=12 ctermbg=15 guifg=#839496 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi InsertMode ctermfg=6 ctermbg=15 guifg=#2aa198 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi ReplaceMode ctermfg=9 ctermbg=15 guifg=#cb4b16 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi VisualMode ctermfg=5 ctermbg=15 guifg=#d33682 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi CommandMode ctermfg=5 ctermbg=15 guifg=#d33682 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  if get(g:, 'solarized_extra_hi_groups', 0)
    hi! link vimVar Identifier
    hi! link vimFunc Function
    hi! link vimUserFunc Function
...
if !has('gui_running') && get(g:, 'solarized_termtrans', 0)
  ...
  hi Folded ctermfg=11 ctermbg=NONE guifg=#657b83 guibg=NONE guisp=#eee8d5 cterm=NONE,bold gui=NONE,bold
  hi LineNr ctermfg=14 ctermbg=NONE guifg=#93a1a1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi Terminal ctermfg=fg ctermbg=NONE guifg=fg guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi CursorLineNr ctermbg=NONE guifg=NONE
else
  hi Normal ctermfg=11 ctermbg=15 guifg=#657b83 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
  hi FoldColumn ctermfg=11 ctermbg=7 guifg=#657b83 guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
  hi Folded ctermfg=11 ctermbg=7 guifg=#657b83 guibg=#fdf6e3 guisp=#eee8d5 cterm=NONE,bold gui=NONE,bold
  hi LineNr ctermfg=14 ctermbg=7 guifg=#93a1a1 guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
  hi Terminal ctermfg=fg ctermbg=15 guifg=fg guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
  hi CursorLineNr ctermbg=7 guibg=#fdf6e3
endif
if get(g:, "solarized_visibility", "") == "high"
  hi CursorLineNr ctermfg=1 guifg=#dc322f cterm=bold gui=bold
  if get(g:, 'solarized_old_cursor_style', 0)
    hi Cursor ctermfg=15 ctermbg=11 guifg=#eee8d5 guibg=#657b83 guisp=NONE cterm=NONE gui=NONE
  else
    hi Cursor ctermfg=15 ctermbg=1 guifg=#eee8d5 guibg=#dc322f guisp=NONE cterm=NONE gui=NONE
  endif
  hi MatchParen ctermfg=15 ctermbg=12 guifg=#eee8d5 guibg=#839496 guisp=NONE cterm=NONE,bold gui=NONE,bold
  ...
  hi SpellBad ctermfg=5 ctermbg=15 guifg=#d33682 guibg=#eee8d5 guisp=#6c71c4 cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
  hi SpellCap ctermfg=5 ctermbg=15 guifg=#d33682 guibg=#eee8d5 guisp=#6c71c4 cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
  hi SpellLocal ctermfg=3 ctermbg=15 guifg=#b58900 guibg=#eee8d5 guisp=#cb4b16 cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
  hi SpellRare ctermfg=6 ctermbg=15 guifg=#2aa198 guibg=#eee8d5 guisp=#cb4b16 cterm=NONE,reverse,underline gui=NONE,reverse,undercurl
...
elseif get(g:, "solarized_visibility", "") == "low"
  ...
  if get(g:, 'solarized_old_cursor_style', 0)
    ...
    hi Cursor ctermfg=15 ctermbg=9 guifg=#eee8d5 guibg=#cb4b16 guisp=NONE cterm=NONE gui=NONE
  endif
  hi MatchParen ctermfg=1 ctermbg=7 guifg=#dc322f guibg=#fdf6e3 guisp=NONE cterm=NONE,bold,underline gui=NONE,bold,underline
  hi NonText ctermfg=7 ctermbg=NONE guifg=#fdf6e3 guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi SpecialKey ctermfg=7 ctermbg=NONE guifg=#fdf6e3 guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
  ...
  hi SpecialKey ctermfg=12 ctermbg=7 guifg=#839496 guibg=#fdf6e3 guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi SpellBad ctermfg=5 ctermbg=NONE guifg=#d33682 guibg=NONE guisp=#6c71c4 cterm=NONE,underline gui=NONE,undercurl
  hi SpellCap ctermfg=5 ctermbg=NONE guifg=#d33682 guibg=NONE guisp=#6c71c4 cterm=NONE,underline gui=NONE,undercurl
  hi SpellLocal ctermfg=3 ctermbg=NONE guifg=#b58900 guibg=NONE guisp=#b58900 cterm=NONE,underline gui=NONE,undercurl
  hi SpellRare ctermfg=6 ctermbg=NONE guifg=#2aa198 guibg=NONE guisp=#2aa198 cterm=NONE,underline gui=NONE,undercurl
...
hi ColorColumn ctermfg=NONE ctermbg=7 guifg=NONE guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
hi Conceal ctermfg=4 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=7 guifg=NONE guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
hi CursorLine ctermfg=NONE ctermbg=7 guifg=NONE guibg=#fdf6e3 guisp=#586e75 cterm=NONE gui=NONE
if get(g:, "solarized_diffmode", "") == "high"
  hi DiffAdd ctermfg=2 ctermbg=NONE guifg=#859900 guibg=NONE guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi DiffChange ctermfg=3 ctermbg=NONE guifg=#b58900 guibg=NONE guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi DiffDelete ctermfg=1 ctermbg=NONE guifg=#dc322f guibg=NONE guisp=NONE cterm=NONE,reverse gui=NONE,reverse
...
elseif get(g:, "solarized_diffmode", "") == "low"
  ...
  hi DiffAdd ctermfg=2 ctermbg=7 guifg=#859900 guibg=#fdf6e3 guisp=#859900 cterm=NONE gui=NONE
  hi DiffChange ctermfg=3 ctermbg=7 guifg=#b58900 guibg=#fdf6e3 guisp=#b58900 cterm=NONE gui=NONE
  hi DiffDelete ctermfg=1 ctermbg=7 guifg=#dc322f guibg=#fdf6e3 guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi DiffText ctermfg=4 ctermbg=7 guifg=#268bd2 guibg=#fdf6e3 guisp=#268bd2 cterm=NONE gui=NONE
endif
hi Directory ctermfg=4 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi EndOfBuffer ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi ErrorMsg ctermfg=1 ctermbg=15 guifg=#dc322f guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
...
hi ModeMsg ctermfg=4 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi MoreMsg ctermfg=4 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Pmenu ctermfg=11 ctermbg=7 guifg=#657b83 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
...
hi PmenuThumb ctermfg=11 ctermbg=15 guifg=#657b83 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi Question ctermfg=6 ctermbg=NONE guifg=#2aa198 guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
hi! link QuickFixLine Search
hi Search ctermfg=3 ctermbg=NONE guifg=#b58900 guibg=NONE guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi SignColumn ctermfg=11 ctermbg=NONE guifg=#657b83 guibg=NONE guisp=NONE cterm=NONE gui=NONE
if get(g:, "solarized_statusline", "") == "low"
  hi StatusLine ctermfg=14 ctermbg=15 guifg=#93a1a1 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  hi TabLineSel ctermfg=10 ctermbg=15 guifg=#586e75 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
else
  hi StatusLine ctermfg=10 ctermbg=7 guifg=#586e75 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi StatusLineNC ctermfg=12 ctermbg=7 guifg=#839496 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TabLine ctermfg=12 ctermbg=7 guifg=#839496 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TabLineFill ctermfg=12 ctermbg=7 guifg=#839496 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi TabLineSel ctermfg=10 ctermbg=7 guifg=#586e75 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
endif
hi! link StatusLineTerm StatusLine
hi! link StatusLineTermNC StatusLineNC
hi VertSplit ctermfg=10 ctermbg=14 guifg=#586e75 guibg=#93a1a1 guisp=NONE cterm=NONE gui=NONE
hi Visual ctermfg=14 ctermbg=15 guifg=#93a1a1 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi VisualNOS ctermfg=NONE ctermbg=7 guifg=NONE guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi WarningMsg ctermfg=9 ctermbg=NONE guifg=#cb4b16 guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
hi WildMenu ctermfg=0 ctermbg=7 guifg=#073642 guibg=#fdf6e3 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi! link Boolean Constant
hi! link Character Constant
...
hi! link lCursor Cursor
hi CursorIM ctermfg=NONE ctermbg=fg guifg=NONE guibg=fg guisp=NONE cterm=NONE gui=NONE
hi ToolbarLine ctermfg=NONE ctermbg=7 guifg=NONE guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
hi ToolbarButton ctermfg=10 ctermbg=7 guifg=#586e75 guibg=#fdf6e3 guisp=NONE cterm=NONE,bold gui=NONE,bold
hi NormalMode ctermfg=10 ctermbg=15 guifg=#586e75 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi InsertMode ctermfg=6 ctermbg=15 guifg=#2aa198 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi ReplaceMode ctermfg=9 ctermbg=15 guifg=#cb4b16 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi VisualMode ctermfg=5 ctermbg=15 guifg=#d33682 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi CommandMode ctermfg=5 ctermbg=15 guifg=#d33682 guibg=#eee8d5 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
if get(g:, 'solarized_extra_hi_groups', 0)
  ...
  hi javaScript ctermfg=3 ctermbg=NONE guifg=#b58900 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi! link jsFuncCall Function
  hi perlHereDoc ctermfg=10 ctermbg=15 guifg=#586e75 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
  hi perlVarPlain ctermfg=3 ctermbg=15 guifg=#b58900 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
  hi perlStatementFileDesc ctermfg=6 ctermbg=15 guifg=#2aa198 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
  hi texstatement ctermfg=6 ctermbg=15 guifg=#2aa198 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
  hi texmathzonex ctermfg=3 ctermbg=15 guifg=#b58900 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
  hi texmathmatcher ctermfg=3 ctermbg=15 guifg=#b58900 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
  hi texreflabel ctermfg=3 ctermbg=15 guifg=#b58900 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
  hi rubyDefine ctermfg=10 ctermbg=15 guifg=#586e75 guibg=#eee8d5 guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi! link rubySymbol Type
  hi rubyBoolean ctermfg=5 ctermbg=15 guifg=#d33682 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
  let hs_highlight_boolean=1
  let hs_highlight_delimiters=1
  hi cPreCondit ctermfg=9 ctermbg=NONE guifg=#cb4b16 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi VarId ctermfg=4 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  ...
  hi! link pandocTableStructureTop pandocTableStructre
  hi! link pandocTableStructureEnd pandocTableStructre
  hi pandocTableZebraLight ctermfg=4 ctermbg=15 guifg=#268bd2 guibg=#eee8d5 guisp=NONE cterm=NONE gui=NONE
  hi pandocTableZebraDark ctermfg=4 ctermbg=7 guifg=#268bd2 guibg=#fdf6e3 guisp=NONE cterm=NONE gui=NONE
  hi pandocEmphasisTable ctermfg=4 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE gui=NONE,italic
  hi pandocEmphasisNestedTable ctermfg=4 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi pandocStrongEmphasisTable ctermfg=4 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
  hi pandocStrongEmphasisNestedTable ctermfg=4 ctermbg=NONE guifg=#268bd2 guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
...
if has('nvim')
  hi! link TermCursor Cursor
  hi TermCursorNC ctermfg=15 ctermbg=14 guifg=#eee8d5 guibg=#93a1a1 guisp=NONE cterm=NONE gui=NONE
  let g:terminal_color_8='#eee8d5'
  let g:terminal_color_0='#fdf6e3'
  let g:terminal_color_10='#93a1a1'
  let g:terminal_color_11='#839496'
...
" Color: base2                #fdf6e3                ~        7
" Color: base3                #eee8d5                ~        15
...
" Color: base02               #fdf6e3                ~        7
" Color: base03               #eee8d5                ~        15
" Color: yellow               #b58900                ~        3
" Color: orange               #cb4b16                ~        9
" Color: red                  #dc322f                ~        1
" Color: magenta              #d33682                ~        5
