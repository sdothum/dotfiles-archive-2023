...
function! s:highlights()
  ...
  execute 'hi CommandCursor   guibg=' . s:dfm_cursor    . ' guifg=' . g:black
  ...
  execute 'hi InsertCursor    guibg=' . s:dfm_cursor    . ' guifg=' . g:black
  execute 'hi MatchParen      guibg=' . s:dfm_match     . ' guifg=' . s:dfm_bg . ' gui=bold'
  execute 'hi ReplaceCursor   guibg=' . s:dfm_cursor    . ' guifg=' . g:black
  ...
  execute 'hi VisualCursor    guibg=' . s:dfm_cursor    . ' guifg=' . g:black
...
"  Distraction free mode _______________________________________________________
