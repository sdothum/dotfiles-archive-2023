...
LUARINGS=tonumber(io.popen('conky color 1'):read(), 16)
default_color=tonumber(io.popen('conky color 1'):read(), 16)
color0=tonumber(io.popen('conky color 1'):read(), 16)
color6=tonumber(io.popen('conky color 1'):read(), 16)
