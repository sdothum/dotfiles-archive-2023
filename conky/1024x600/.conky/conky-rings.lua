...
clock_h = {
    ...
    graduation_fg_colour=COLORING, graduation_fg_alpha=0.3,
    },
}
-- MINUTES
clock_m = {
    ...
    graph_bg_colour=COLORING,      graph_bg_alpha=0.05,
...
clock_s = {
    ...
    graduation_fg_colour=COLORING, graduation_fg_alpha=0,
    },
}
...
temp = {
{
    name='exec',                   arg="sensors | grep 'Core .:' | sed -e 's/^.*  [+]//' -e '...C  *[(].*$//' | sort | tail -1", max_value=100,
    x=69,                          y=277,
    graph_radius=25,
    graph_thickness=3,
    graph_start_angle=180,
    graph_unit_angle=2.7,          graph_unit_thickness=2.7,
    graph_bg_colour=COLORING,      graph_bg_alpha=0.06,
    graph_fg_colour=color0,        graph_fg_alpha=0.66,
    hand_fg_colour=color0,         hand_fg_alpha=0,
    txt_radius=17,
    txt_weight=0,                  txt_size=8.0,
    txt_fg_colour=COLORING,        txt_fg_alpha=0.5,
...
},
{
    ...
    graduation_thickness=0,        graduation_mark_thickness=1,
    graduation_unit_angle=27,
    graduation_fg_colour=COLORING, graduation_fg_alpha=0.5,
    caption='',
    caption_weight=1,              caption_size=8.0,
    caption_fg_colour=COLORING,    caption_fg_alpha=0.3,
},
...
},
{
    ...
    graph_unit_angle=2.7,          graph_unit_thickness=2.7,
    graph_bg_colour=COLORING,      graph_bg_alpha=0,
    graph_fg_colour=0x292929,      graph_fg_alpha=0.66,
    hand_fg_colour=color0,         hand_fg_alpha=0,
    txt_radius=17,
    txt_weight=0,                  txt_size=8.0,
    txt_fg_colour=COLORING,        txt_fg_alpha=0.5,
...
-- hide unknown
function conky_battery( time )
    return string.gsub( conky_parse( time ), 'unknown', '')
end
