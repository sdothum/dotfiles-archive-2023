...
#else
      _______ , _______ , _______ , TT_ESC  , TT_I    , _______ , _______ , TT_SPC  , KC_BSPC , _______ , _______ , _______ 
#endif
  // ---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------
  ),
...
// ....................................................... Numberic Keypad Layer
  ...
  // ---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------
      _______ , TD_X    , AST_G   , KC_BSLS , _______ , ___x___ , ___x___ , TD_COMM , KC_1    , KC_2    , KC_3    , KC_PLUS ,
  // ---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------
#ifdef SPLITOGRAPHY
#ifdef THUMB_0
...
// ....................................................................... Regex
  ...
  [_TTREGEX] = KEYMAP( 
  // ---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------
      _______ , KC_DOT  , KC_ASTR , KC_AMPR , KC_PIPE , ___x___ , ___x___ , KC_PIPE , KC_LBRC , KC_CIRC , KC_RBRC , _______ ,
  // ---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------
      _______ , KC_LT   , KC_PERC , KC_GT   , KC_QUES , ___x___ , ___x___ , KC_QUES , KC_LPRN , KC_DLR  , KC_RPRN , _______ ,
  // ---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------
      _______ , KC_PLUS , KC_AT   , KC_SLSH , KC_EXLM , ___x___ , ___x___ , KC_ASTR , KC_LCBR , KC_HASH , KC_RCBR , _______ ,
  // ---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------
#ifdef SPLITOGRAPHY
      _______ , _______ , _______ , _______ , TT_ESC  , KC_EQL  , KC_BSLS , KC_DEL  , _______ , _______ , _______ , _______ 
#else
      _______ , _______ , _______ , TT_ESC  , KC_EQL  , _______ , _______ , KC_BSLS , KC_DEL  , _______ , _______ , _______ 
#endif
  // ---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------+---------
  ),
