...
// .............................................................. CapsLock Layer
  ...
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
      ___x___ , S(KC_Q) , S(KC_H) , S(KC_E) , TT_A    , KC_DOT  ,                      S(KC_C) , TT_T    , S(KC_R) , S(KC_S) , S(KC_W) , ___x___ ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
  ...
  [_TTBASEL] = KEYMAP(
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
      ___x___ , KC_Z    , KC_Y    , KC_O    , KC_U    , KC_COLN ,                      KC_G    , KC_D    , KC_N    , KC_M    , KC_X    , ___x___ ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
      ___x___ , KC_Q    , KC_H    , KC_E    , ___x___ , KC_DOT  ,                      KC_C    , KC_T    , KC_R    , KC_S    , KC_W    , ___x___ ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
      ___x___ , KC_J    , KC_MINS , KC_QUOT , KC_K    , KC_COMM ,                      KC_B    , KC_P    , KC_L    , KC_F    , KC_V    , ___x___ ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
                                              ___x___ , KC_I    , KC_TAB  ,  KC_ENT  , KC_SPC  , KC_BSPC 
  //                                         ---------+---------+---------  ---------+---------+--------- 
  ),
  ...
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
      ___x___ , KC_Z    , KC_Y    , KC_O    , KC_U    , KC_COLN ,                      KC_G    , KC_D    , KC_N    , KC_M    , KC_X    , ___x___ ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
      ___x___ , KC_Q    , KC_H    , KC_E    , KC_A    , KC_DOT  ,                      KC_C    , ___x___ , KC_R    , KC_S    , KC_W    , ___x___ ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
      ___x___ , KC_J    , KC_MINS , KC_QUOT , KC_K    , KC_COMM ,                      KC_B    , KC_P    , KC_L    , KC_F    , KC_V    , ___x___ ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
                                              ___x___ , KC_I    , KC_TAB  ,  KC_ENT  , KC_SPC  , KC_BSPC 
...
// ....................................................... Numberic Keypad Layer
  ...
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
                                              TT_ESC  , KC_SPC  , _______ ,  KC_BSLS , KC_0    , KC_EQL 
  //                                         ---------+---------+---------  ---------+---------+--------- 
  ),
