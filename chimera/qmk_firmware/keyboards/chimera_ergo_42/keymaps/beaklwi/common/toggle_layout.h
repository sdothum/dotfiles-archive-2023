...
// .............................................................. CapsLock Layer
  ...
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
       __x__  , S(KC_Q) , S(KC_H) , S(KC_E) , TT_A    , S(KC_W) ,                      S(KC_C) , TT_T    , S(KC_R) , S(KC_S) , S(KC_B) ,  __x__  ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
       __x__  , S(KC_J) , KC_COMM , KC_DOT  , S(KC_K) , KC_QUOT ,                      S(KC_V) , S(KC_P) , S(KC_L) , S(KC_F) , S(KC_X) ,  __x__  ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
  ...
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
       __x__  , KC_Q    , KC_H    , KC_E    ,  __x__  , KC_W    ,                      KC_C    , KC_T    , KC_R    , KC_S    , KC_B    ,  __x__  ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
       __x__  , KC_J    , KC_COMM , KC_DOT  , KC_K    , KC_QUOT ,                      KC_V    , KC_P    , KC_L    , KC_F    , KC_X    ,  __x__  ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
  ...
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
       __x__  , KC_Q    , KC_H    , KC_E    , KC_A    , KC_W    ,                      KC_C    ,  __x__  , KC_R    , KC_S    , KC_B    ,  __x__  ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
       __x__  , KC_J    , KC_GRV  , KC_TILD , KC_K    , KC_DQT  ,                      KC_V    , KC_P    , KC_L    , KC_F    , KC_X    ,  __x__  ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
