...
// .............................................................. CapsLock Layer
  ...
  [_TTCAPS] = KEYMAP(
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
       __x__  , KC_COLN , S(KC_Y) , S(KC_O) , S(KC_U) , KC_MINS ,                      S(KC_G) , S(KC_D) , S(KC_N) , S(KC_M) , S(KC_Z) ,  __x__  ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
  ...
  [_TTBASEL] = KEYMAP(
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
       __x__  , KC_COLN , KC_Y    , KC_O    , KC_U    , KC_MINS ,                      KC_G    , KC_D    , KC_N    , KC_M    , KC_Z    ,  __x__  ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
  ...
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
       __x__  , KC_J    , KC_GRV  , KC_TILD , KC_K    , KC_DQT  ,                      KC_B    , KC_P    , KC_L    , KC_F    , KC_X    ,  __x__  ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
...
// ....................................................... Numberic Keypad Layer
  ...
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
#ifdef UPPER_HEX
       __x__  ,   ___   , S(KC_F) , ACT_E   , S(KC_D) ,   ___   ,                      KC_SLSH , KC_4    , KC_5    , KC_9    , KC_ASTR ,  __x__  ,
#else                                                                                                                    
       __x__  ,   ___   , KC_F    , ACT_E   , KC_D    ,   ___   ,                      KC_SLSH , KC_4    , KC_5    , KC_9    , KC_ASTR ,  __x__  ,
#endif                                                                                                                   
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
       __x__  , OS_GUI  , CT_C    , AT_B    , ST_A    ,   ___   ,                      TD_DOT  , KC_1    , KC_2    , KC_3    , KC_MINS ,  __x__  ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
...
// ....................................................................... Regex
  ...
  [_TTREGEX] = KEYMAP(
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
       __x__  ,   ___   , KC_DOT  , KC_ASTR , KC_AMPR , KC_PLUS ,                      KC_ASTR , KC_LBRC , KC_CIRC , KC_RBRC ,   ___   ,  __x__  ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
       __x__  ,   ___   , KC_QUES , KC_EXLM , KC_SLSH , KC_PIPE ,                      KC_QUES , KC_LPRN , KC_DLR ,  KC_RPRN ,   ___   ,  __x__  ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
       __x__  ,   ___   , KC_LT   , KC_GT   , KC_PERC , KC_AT   ,                      KC_PIPE , KC_LCBR , KC_HASH , KC_RCBR ,   ___   ,  __x__  ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
