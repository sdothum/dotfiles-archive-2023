...
// .............................................................. CapsLock Layer
  ...
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
      ___x___ , S(KC_Q) , S(KC_H) , S(KC_E) , SST_A   , KC_DOT  ,                      S(KC_C) , SST_T   , S(KC_R) , S(KC_S) , S(KC_W) , ___x___ ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------+
      ___x___ , S(KC_J) , KC_MINS , KC_QUOT , S(KC_K) , KC_COMM ,                      S(KC_B) , S(KC_P) , S(KC_L) , S(KC_F) , S(KC_V) , ___x___ ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
                                              TT_ESC  , S(KC_I) , KC_TAB  ,  KC_ENT  , TT_SPC  , KC_BSPC 
  //                                         ---------+---------+---------  ---------+---------+--------- 
  ),
...
// ....................................................... Numberic Keypad Layer
  ...
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
                                              TT_ESC  , KC_SPC  , _______ ,  KC_BSLS , KC_0    , KC_PERC 
  //                                         ---------+---------+---------  ---------+---------+--------- 
  ),
...
// ....................................................................... Regex
  ...
  [_TTREGEX] = KEYMAP(
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
      ___x___ , _______ , KC_DOT  , KC_ASTR , KC_AMPR , KC_PIPE ,                      TD_ASTR , KC_LBRC , KC_CIRC , KC_RBRC , _______ , ___x___ ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
      ___x___ , _______ , KC_LT   , KC_PERC , KC_GT   , KC_QUES ,                      KC_PIPE , KC_LPRN , KC_DLR ,  KC_RPRN , _______ , ___x___ ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
      ___x___ , _______ , KC_PLUS , KC_AT   , KC_EXLM , KC_SLSH ,                      KC_SLSH , KC_LCBR , KC_HASH , KC_RCBR , _______ , ___x___ ,
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+--------- 
                                              TT_ESC  , KC_BSLS , KC_EQL  ,  KC_ENT  , KC_BSLS , KC_DEL  
  //                                         ---------+---------+---------  ---------+---------+--------- 
  ),
